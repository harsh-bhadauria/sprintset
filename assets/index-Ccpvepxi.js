...
`,`"`,s.BYTE_ORDER_MARK],s.WORKERS_SUPPORTED=!r&&!!t.Worker,s.NODE_STREAM_INPUT=1,s.LocalChunkSize=10485760,s.RemoteChunkSize=5242880,s.DefaultDelimiter=`,`,s.Parser=g,s.ParserHandle=m,s.NetworkStreamer=u,s.FileStreamer=d,s.StringStreamer=f,s.ReadableStreamStreamer=p,t.jQuery&&((n=t.jQuery).fn.parse=function(e){var r=e.config||{},i=[];return this.each(function(e){if(!(n(this).prop(`tagName`).toUpperCase()===`INPUT`&&n(this).attr(`type`).toLowerCase()===`file`&&t.FileReader)||!this.files||this.files.length===0)return!0;for(var a=0;a<this.files.length;a++)i.push({file:this.files[a],inputElem:this,instanceConfig:n.extend({},r)})}),a(),this;function a(){if(i.length===0)S(e.complete)&&e.complete();else{var t,r,a,c,l=i[0];if(S(e.before)){var u=e.before(l.file,l.inputElem);if(typeof u==`object`){if(u.action===`abort`)return t=`AbortError`,r=l.file,a=l.inputElem,c=u.reason,void(S(e.error)&&e.error({name:t},r,a,c));if(u.action===`skip`)return void o();typeof u.config==`object`&&(l.instanceConfig=n.extend(l.instanceConfig,u.config))}else if(u===`skip`)return void o()}var d=l.instanceConfig.complete;l.instanceConfig.complete=function(e){S(d)&&d(e,l.file,l.inputElem),o()},s.parse(l.file,l.instanceConfig)}}function o(){i.splice(0,1),a()}}),i&&(t.onmessage=function(e){e=e.data,s.WORKER_ID===void 0&&e&&(s.WORKER_ID=e.workerId),typeof e.input==`string`?t.postMessage({workerId:s.WORKER_ID,results:s.parse(e.input,e.config),finished:!0}):(t.File&&e.input instanceof File||e.input instanceof Object)&&(e=s.parse(e.input,e.config))&&t.postMessage({workerId:s.WORKER_ID,results:e,finished:!0})}),(u.prototype=Object.create(l.prototype)).constructor=u,(d.prototype=Object.create(l.prototype)).constructor=d,(f.prototype=Object.create(f.prototype)).constructor=f,(p.prototype=Object.create(l.prototype)).constructor=p,s})}))(),1);function at(e){if(e.sheets&&String(e.sheets).trim()!==``){let t=String(e.sheets).split(`;`).map(e=>e.trim()).filter(Boolean);if(t.length>0)return t}return e.sheet&&String(e.sheet).trim()!==``?[String(e.sheet).trim()]:[`Default`]}function ot(e){return new Promise((t,n)=>{it.default.parse(e,{header:!0,skipEmptyLines:!0,dynamicTyping:!1,complete:e=>{e.errors&&e.errors.length>0&&console.warn(`CSV Parse Warnings:`,e.errors),t(e.data.filter(e=>e.name&&String(e.name).trim()!==``).map((e,t)=>({id:e.id?String(e.id).trim():`q-${Date.now()}-${t}`,name:String(e.name||``).trim(),topic:String(e.topic||`General`).trim(),difficulty:ct(e.difficulty),sheets:at(e),link:String(e.link||``).trim()})))},error:e=>n(e)})})}function st(e,t=`questions.csv`){let n=e.map(e=>({id:e.id,name:e.name,topic:e.topic,difficulty:e.difficulty,sheets:Array.isArray(e.sheets)?e.sheets.join(`; `):e.sheet||`Default`,link:e.link||``})),r=it.default.unparse(n,{columns:[`id`,`name`,`topic`,`difficulty`,`sheets`,`link`]}),i=new Blob([r],{type:`text/csv;charset=utf-8;`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.setAttribute(`href`,a),o.setAttribute(`download`,t),document.body.appendChild(o),o.click(),document.body.removeChild(o)}function ct(e){if(!e)return`Medium`;let t=String(e).trim().toLowerCase();return t.includes(`easy`)?`Easy`:t.includes(`hard`)?`Hard`:`Medium`}var lt=e=>{if(!e)return[`Default`];if(Array.isArray(e.sheets)&&e.sheets.length>0){let t=e.sheets.map(e=>String(e).trim()).filter(Boolean);return t.length>0?t:[`Default`]}return e.sheet&&String(e.sheet).trim()!==``?[String(e.sheet).trim()]:[`Default`]},ut=e=>e&&e.link&&String(e.link).trim()!==``?String(e.link).trim():`https://www.google.com/search?q=${encodeURIComponent(`${e?e.name:``} leetcode`)}`,dt=(e,t=[],n=null,r=5)=>{let i=[];if(Array.isArray(t)&&t.length>0&&t.forEach(t=>{Array.isArray(t.results)&&t.results.forEach(n=>{if(n.questionId===e){let e=t.completedAt||t.timestamp?new Date(t.completedAt||t.timestamp).toLocaleDateString():``,r=`ok`,a=`OK`;n.confidence===`solid`||n.confidence===`tooEasy`?(r=`solid`,a=`Solid`):n.confidence===`shaky`||n.status===`skipped`?(r=`shaky`,a=`Shaky`):n.status===`gaveUp`||n.confidence===`wrong`?(r=`gaveUp`,a=`Gave Up`):(n.confidence===`ok`||n.status===`done`)&&(r=`ok`,a=`OK`),i.push({type:r,label:a,date:e})}})}),i.length===0&&n){let e=`ok`,t=`OK`,r=n.lastAttemptedAt?new Date(n.lastAttemptedAt).toLocaleDateString():``;n.confidence===`solid`||n.confidence===`tooEasy`?(e=`solid`,t=`Solid`):n.confidence===`shaky`||n.status===`skipped`?(e=`shaky`,t=`Shaky`):n.status===`gaveUp`||n.confidence===`wrong`?(e=`gaveUp`,t=`Gave Up`):n.confidence===`ok`&&(e=`ok`,t=`OK`),i.push({type:e,label:t,date:r})}return i.slice(-r)},ft=(e,t,n=null)=>{let r=[...e];return t.forEach(e=>{let t=String(e.name||``).trim().toLowerCase();if(!t)return;let i=r.findIndex(e=>String(e.name||``).trim().toLowerCase()===t),a=n||e.sheets&&e.sheets[0]||e.sheet||`Default`;if(i!==-1){let t=r[i],n=lt(t),o=Array.from(new Set([...n,a]));r[i]={...t,sheets:o,link:t.link||e.link||``,topic:t.topic||e.topic||`General`}}else{let t=n?[n]:e.sheets&&e.sheets.length>0?e.sheets:[e.sheet||`Default`];r.push({id:e.id||`q-${Date.now()}-${Math.random().toString(36).substr(2,5)}`,name:String(e.name).trim(),topic:String(e.topic||`General`).trim(),difficulty:e.difficulty||`Medium`,sheets:t,link:String(e.link||``).trim()})}}),r};function pt({questions:e,questionStates:t={},sessions:n=[],onUpdateQuestions:r,onUpdateQuestionStates:i,onResetToDefault:a}){let[o,s]=(0,_.useState)(null),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(()=>{try{let e=localStorage.getItem(`sprintset_custom_sheets_v1`);return e?JSON.parse(e):[]}catch{return[]}}),[f,p]=(0,_.useState)(!1),[m,h]=(0,_.useState)(!1),g=(0,_.useRef)(null),v=(0,_.useRef)(null),[y,b]=(0,_.useState)(``),[x,S]=(0,_.useState)(`ALL`),[C,w]=(0,_.useState)(`ALL`),[ee,T]=(0,_.useState)(!1),[te,E]=(0,_.useState)(``),[O,ne]=(0,_.useState)(null),[A,j]=(0,_.useState)(!1),[re,N]=(0,_.useState)(null),[P,F]=(0,_.useState)({id:``,name:``,topic:`Arrays & Hashing`,difficulty:`Medium`,sheets:[`Default`],link:``}),[ie,ae]=(0,_.useState)(!1),[I,se]=(0,_.useState)(``),[ce,le]=(0,_.useState)(!1),[R,ue]=(0,_.useState)(`GLOBAL`),[fe,pe]=(0,_.useState)(`topic`),[he,ge]=(0,_.useState)(``),[_e,ye]=(0,_.useState)(``);(0,_.useEffect)(()=>{let e=e=>{g.current&&!g.current.contains(e.target)&&p(!1),v.current&&!v.current.contains(e.target)&&h(!1)};return document.addEventListener(`mousedown`,e),()=>document.removeEventListener(`mousedown`,e)},[]);let Ce=e=>{d(e);try{localStorage.setItem(`sprintset_custom_sheets_v1`,JSON.stringify(e))}catch(e){console.error(`Error saving custom sheets:`,e)}},Te=(0,_.useMemo)(()=>{let t=new Map;return u.forEach(e=>{e&&e.trim()!==``&&t.set(e.trim(),[])}),e.forEach(e=>{lt(e).forEach(n=>{t.has(n)||t.set(n,[]),t.get(n).push(e)})}),t},[e,u]),De=(0,_.useMemo)(()=>{let e=[`Striver A2Z`,`Blind 75`,`NeetCode 150`];return Array.from(Te.keys()).sort((t,n)=>{let r=e.indexOf(t),i=e.indexOf(n);return r!==-1&&i!==-1?r-i:r===-1?i!==-1||t===`Default`?1:n===`Default`?-1:t.localeCompare(n):-1})},[Te]),Oe=(0,_.useMemo)(()=>o?o===`ALL`?e:e.filter(e=>lt(e).includes(o)):[],[e,o]),je=(0,_.useMemo)(()=>{let t=new Set(e.map(e=>e.topic||`General`));return Array.from(t).sort()},[e]),Me=(0,_.useMemo)(()=>Oe.filter(e=>{let t=lt(e),n=y===``||e.name.toLowerCase().includes(y.toLowerCase())||e.topic.toLowerCase().includes(y.toLowerCase())||t.some(e=>e.toLowerCase().includes(y.toLowerCase())),r=x===`ALL`||e.topic===x,i=C===`ALL`||e.difficulty===C;return n&&r&&i}),[Oe,y,x,C]),Pe=(0,_.useMemo)(()=>!R||R===`GLOBAL`||R===`ALL`?e:e.filter(e=>lt(e).includes(R)),[e,R]),Fe=(0,_.useMemo)(()=>{if(!he||!he.trim())return 0;let e=he.trim().toLowerCase();return Pe.filter(t=>fe===`sheet`?lt(t).some(t=>t.toLowerCase()===e):(t[fe]||``).toString().trim().toLowerCase()===e).length},[Pe,fe,he]),Ie=e=>({easy:e.filter(e=>e.difficulty===`Easy`).length,medium:e.filter(e=>e.difficulty===`Medium`).length,hard:e.filter(e=>e.difficulty===`Hard`).length,attempted:e.filter(e=>t[e.id]).length}),ze=async t=>{let n=t.target.files[0];if(!(!n||!o||o===`ALL`))try{let t=await ot(n);if(t.length===0){alert(`No valid question rows found in CSV.`);return}r(ft(e,t,o)),h(!1),alert(`Successfully processed ${t.length} rows into "${o}"!`)}catch(e){alert(`Error parsing CSV file: `+e.message)}},Be=e=>{ue(e),pe(`topic`),ge(``),ye(``),p(!1),h(!1),le(!0)},Ve=t=>{if(t.preventDefault(),!he.trim()||!_e.trim()){alert(`Please provide both old and new values.`);return}if(Fe===0){alert(`No matching questions found.`);return}let n=he.trim(),i=_e.trim(),a=!R||R===`GLOBAL`||R===`ALL`?`all questions`:`questions in "${R}"`,o=`This will update ${Fe} question${Fe===1?``:`s`} (${a}) from '${n}' to '${i}'.\n\nAre you sure you want to proceed?`;if(window.confirm(o)){let t=new Set(Pe.map(e=>e.id)),a=n.toLowerCase();r(e.map(e=>{if(t.has(e.id)){if(fe===`sheet`){let t=lt(e);if(t.some(e=>e.toLowerCase()===a)){let n=t.map(e=>e.toLowerCase()===a?i:e);return{...e,sheets:Array.from(new Set(n))}}}else if((e[fe]||``).toString().trim().toLowerCase()===a)return{...e,[fe]:i}}return e})),le(!1),alert(`Updated ${Fe} question${Fe===1?``:`s`}.`)}},He=()=>{E(``),ne(null),T(!0)},Ue=async t=>{if(t.preventDefault(),!te.trim()){alert(`Please enter a sheet name.`);return}let n=te.trim();if(u.includes(n)||Ce([...u,n]),O)try{let t=await ot(O);t.length>0&&r(ft(e,t,n))}catch(e){alert(`Error parsing sheet CSV file: `+e.message)}T(!1),s(n)},We=()=>{N(null);let e=o&&o!==`ALL`?[o]:[`Default`];F({id:`custom-${Date.now()}`,name:``,topic:je[0]||`Arrays & Hashing`,difficulty:`Medium`,sheets:e,link:``}),ae(!1),se(``),j(!0)},Ge=e=>{N(e),F({...e,sheets:lt(e)}),ae(!1),se(``),j(!0)},qe=e=>{let t=P.sheets||[];if(t.includes(e)){let n=t.filter(t=>t!==e);F({...P,sheets:n.length>0?n:[`Default`]})}else F({...P,sheets:[...t,e]})},Je=t=>{window.confirm(`Are you sure you want to delete this question?`)&&r(e.filter(e=>e.id!==t))},Ye=n=>{if(!n||n===`Default`||n===`ALL`)return;let a=e.filter(e=>lt(e).includes(n)),o=a.length,c=a.filter(e=>lt(e).filter(e=>e!==n).length===0),l=c.length,d=`${o} question${o===1?``:`s`} will be removed from "${n}"; ${l} of those aren't in any other sheet and will be deleted entirely.\n\nAre you sure you want to proceed?`;if(window.confirm(d)){let a=new Set(c.map(e=>e.id)),o=e.filter(e=>!a.has(e.id)).map(e=>{if(lt(e).includes(n)){let t=lt(e).filter(e=>e!==n);return{...e,sheets:t.length>0?t:[`Default`]}}return e}),l={...t};a.forEach(e=>{delete l[e]}),Ce(u.filter(e=>e!==n)),i&&i(l),r(o),s(null),h(!1)}},Xe=n=>{if(!n)return;let r=n===`ALL`?e:Te.get(n)||[],a=r.length,o=`Reset practice history (attempts & confidence) for all ${a} question${a===1?``:`s`} in "${n}"?`;if(window.confirm(o)){let e=new Set(r.map(e=>e.id)),a={...t};e.forEach(e=>{delete a[e]}),i&&i(a),h(!1),alert(`Cleared practice history for "${n}".`)}},Ze=t=>{if(t.preventDefault(),!P.name.trim()){alert(`Question Name is required.`);return}let n=[...P.sheets||[`Default`]];if(ie&&I.trim()){let e=I.trim();u.includes(e)||Ce([...u,e]),n.includes(e)||n.push(e)}let i={...P,sheets:n.length>0?n:[`Default`]};r(re?e.map(e=>e.id===re.id?i:e):ft(e,[i])),j(!1)},Qe=()=>{s(null),l(!1),b(``),S(`ALL`),w(`ALL`)},$e=Ie(e);return(0,B.jsxs)(`div`,{className:`bank-container glass-card`,children:[o===null?(0,B.jsxs)(`div`,{className:`sheets-overview-view`,children:[(0,B.jsxs)(`div`,{className:`bank-header`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`h2`,{className:`bank-title`,children:[`Question Bank (`,e.length,`)`]}),(0,B.jsx)(`p`,{className:`bank-subtitle`,children:`Select a sheet to explore questions, or view all questions in a flat list.`})]}),(0,B.jsxs)(`div`,{className:`bank-header-actions`,children:[(0,B.jsxs)(`button`,{className:`btn btn-primary`,onClick:He,children:[(0,B.jsx)(de,{size:16}),(0,B.jsx)(`span`,{children:`Add Sheet`})]}),(0,B.jsxs)(`div`,{className:`kebab-menu-wrapper`,ref:g,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary kebab-trigger-btn`,onClick:()=>p(!f),title:`More Bank Actions`,children:(0,B.jsx)(oe,{size:18})}),f&&(0,B.jsxs)(`div`,{className:`kebab-dropdown-menu`,children:[(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn`,onClick:()=>{st(e,`sprintset_all_questions.csv`),p(!1)},children:[(0,B.jsx)(Le,{size:15}),(0,B.jsx)(`span`,{children:`Export All (CSV)`})]}),(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn`,onClick:()=>Be(`GLOBAL`),children:[(0,B.jsx)(Se,{size:15}),(0,B.jsx)(`span`,{children:`Find & Replace`})]}),(0,B.jsx)(`div`,{className:`dropdown-divider`}),(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn item-danger`,onClick:()=>{p(!1),window.confirm(`Reset question bank back to default starter set?`)&&a()},children:[(0,B.jsx)(we,{size:15}),(0,B.jsx)(`span`,{children:`Reset Bank`})]})]})]})]})]}),(0,B.jsxs)(`div`,{className:`sheets-grid-section`,children:[(0,B.jsx)(`h3`,{className:`section-grid-title`,children:`Problem Sheets & Collections`}),(0,B.jsxs)(`div`,{className:`sheet-cards-grid`,children:[(0,B.jsxs)(`div`,{className:`sheet-card card-all-questions`,onClick:()=>s(`ALL`),children:[(0,B.jsxs)(`div`,{className:`sheet-card-header`,children:[(0,B.jsx)(`div`,{className:`sheet-icon-badge icon-all-badge`,children:(0,B.jsx)(me,{size:22})}),(0,B.jsx)(`span`,{className:`sheet-type-pill pill-all`,children:`Flat View`})]}),(0,B.jsxs)(`div`,{className:`sheet-card-body`,children:[(0,B.jsx)(`h3`,{className:`sheet-card-title`,children:`All Questions`}),(0,B.jsxs)(`div`,{className:`sheet-main-count`,children:[e.length,` `,(0,B.jsx)(`span`,{children:`Questions`})]}),(0,B.jsxs)(`div`,{className:`sheet-diff-breakdown`,children:[(0,B.jsxs)(`span`,{className:`diff-tag tag-easy`,children:[$e.easy,` Easy`]}),(0,B.jsx)(`span`,{className:`dot-sep`,children:`•`}),(0,B.jsxs)(`span`,{className:`diff-tag tag-medium`,children:[$e.medium,` Med`]}),(0,B.jsx)(`span`,{className:`dot-sep`,children:`•`}),(0,B.jsxs)(`span`,{className:`diff-tag tag-hard`,children:[$e.hard,` Hard`]})]})]}),(0,B.jsx)(`div`,{className:`sheet-card-footer`,children:(0,B.jsxs)(`span`,{className:`view-sheet-btn`,children:[`View All Questions `,(0,B.jsx)(M,{size:16})]})})]}),De.map(e=>{let t=Te.get(e)||[],n=Ie(t);return(0,B.jsxs)(`div`,{className:`sheet-card`,onClick:()=>s(e),children:[(0,B.jsxs)(`div`,{className:`sheet-card-header`,children:[(0,B.jsx)(`div`,{className:`sheet-icon-badge`,children:(0,B.jsx)(k,{size:20})}),(0,B.jsx)(`span`,{className:`sheet-type-pill`,children:`Sheet`})]}),(0,B.jsxs)(`div`,{className:`sheet-card-body`,children:[(0,B.jsx)(`h3`,{className:`sheet-card-title`,children:e}),(0,B.jsxs)(`div`,{className:`sheet-main-count`,children:[t.length,` `,(0,B.jsx)(`span`,{children:`Questions`})]}),(0,B.jsxs)(`div`,{className:`sheet-diff-breakdown`,children:[(0,B.jsxs)(`span`,{className:`diff-tag tag-easy`,children:[n.easy,` Easy`]}),(0,B.jsx)(`span`,{className:`dot-sep`,children:`•`}),(0,B.jsxs)(`span`,{className:`diff-tag tag-medium`,children:[n.medium,` Med`]}),(0,B.jsx)(`span`,{className:`dot-sep`,children:`•`}),(0,B.jsxs)(`span`,{className:`diff-tag tag-hard`,children:[n.hard,` Hard`]})]})]}),(0,B.jsxs)(`div`,{className:`sheet-card-footer`,children:[(0,B.jsx)(`span`,{className:`attempted-indicator`,children:n.attempted>0?`${n.attempted}/${t.length} Attempted`:`Not started`}),(0,B.jsxs)(`span`,{className:`view-sheet-btn`,children:[`Open Sheet `,(0,B.jsx)(M,{size:16})]})]})]},e)})]})]})]}):(0,B.jsxs)(`div`,{className:`sheet-detail-view`,children:[(0,B.jsxs)(`div`,{className:`bank-header`,children:[(0,B.jsxs)(`div`,{className:`header-title-with-back`,children:[(0,B.jsxs)(`button`,{type:`button`,className:`btn-back-sheets`,onClick:Qe,title:`Return to Sheets Overview`,children:[(0,B.jsx)(D,{size:16}),(0,B.jsx)(`span`,{children:`All Sheets`})]}),(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`h2`,{className:`bank-title`,children:[o===`ALL`?`All Questions`:o,(0,B.jsx)(`span`,{className:`header-count-pill`,children:Oe.length})]}),(0,B.jsx)(`p`,{className:`bank-subtitle`,children:o===`ALL`?`Viewing every question across all sheets in your question bank.`:`Viewing questions in the ${o} sheet.`})]})]}),(0,B.jsxs)(`div`,{className:`bank-header-actions`,children:[(0,B.jsxs)(`button`,{className:`btn btn-primary`,onClick:We,children:[(0,B.jsx)(be,{size:16}),(0,B.jsx)(`span`,{children:`Add Question`})]}),(0,B.jsxs)(`button`,{type:`button`,className:`btn btn-secondary btn-edit-mode-toggle ${c?`edit-mode-active`:``}`,onClick:()=>l(!c),title:c?`Exit Edit Mode`:`Enable Edit Mode to edit or delete questions`,children:[(0,B.jsx)(ve,{size:15}),(0,B.jsx)(`span`,{children:c?`Done Editing`:`Edit Mode`})]}),(0,B.jsxs)(`div`,{className:`kebab-menu-wrapper`,ref:v,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary kebab-trigger-btn`,onClick:()=>h(!m),title:`Sheet Actions`,children:(0,B.jsx)(oe,{size:18})}),m&&(0,B.jsx)(`div`,{className:`kebab-dropdown-menu`,children:o===`ALL`?(0,B.jsxs)(B.Fragment,{children:[(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn`,onClick:()=>{st(e,`sprintset_all_questions.csv`),h(!1)},children:[(0,B.jsx)(Le,{size:15}),(0,B.jsx)(`span`,{children:`Export All (CSV)`})]}),(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn`,onClick:()=>Be(`ALL`),children:[(0,B.jsx)(Se,{size:15}),(0,B.jsx)(`span`,{children:`Find & Replace`})]})]}):(0,B.jsxs)(B.Fragment,{children:[(0,B.jsxs)(`label`,{className:`menu-item-btn cursor-pointer`,children:[(0,B.jsx)(L,{size:15}),(0,B.jsx)(`span`,{children:`Batch Import`}),(0,B.jsx)(`input`,{type:`file`,accept:`.csv`,onChange:ze,style:{display:`none`}})]}),(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn`,onClick:()=>{let e=`sprintset_${o.toLowerCase().replace(/\s+/g,`_`)}_questions.csv`;st(Oe,e),h(!1)},children:[(0,B.jsx)(Le,{size:15}),(0,B.jsx)(`span`,{children:`Export Sheet`})]}),(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn`,onClick:()=>Be(o),children:[(0,B.jsx)(Se,{size:15}),(0,B.jsx)(`span`,{children:`Find & Replace`})]}),(0,B.jsx)(`div`,{className:`dropdown-divider`}),(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn`,onClick:()=>Xe(o),children:[(0,B.jsx)(xe,{size:15}),(0,B.jsx)(`span`,{children:`Reset History`})]}),o!==`Default`&&(0,B.jsxs)(`button`,{type:`button`,className:`menu-item-btn item-danger`,onClick:()=>Ye(o),children:[(0,B.jsx)(Ne,{size:15}),(0,B.jsx)(`span`,{children:`Delete Sheet`})]})]})})]})]})]}),(0,B.jsxs)(`div`,{className:`bank-controls`,children:[(0,B.jsxs)(`div`,{className:`search-box`,children:[(0,B.jsx)(Ee,{size:18,className:`search-icon`}),(0,B.jsx)(`input`,{type:`text`,className:`search-input`,placeholder:o===`ALL`?`Search all questions by name, topic, or sheet...`:`Search in ${o}...`,value:y,onChange:e=>b(e.target.value)}),y&&(0,B.jsx)(`button`,{className:`clear-search`,onClick:()=>b(``),children:(0,B.jsx)(Re,{size:14})})]}),(0,B.jsxs)(`div`,{className:`filters-row`,children:[(0,B.jsxs)(`div`,{className:`select-wrapper`,children:[(0,B.jsx)(z,{size:14}),(0,B.jsxs)(`select`,{value:x,onChange:e=>S(e.target.value),className:`filter-select`,children:[(0,B.jsxs)(`option`,{value:`ALL`,children:[`All Topics (`,je.length,`)`]}),je.map(e=>(0,B.jsx)(`option`,{value:e,children:Ke(e)},e))]})]}),(0,B.jsx)(`div`,{className:`select-wrapper`,children:(0,B.jsxs)(`select`,{value:C,onChange:e=>w(e.target.value),className:`filter-select`,children:[(0,B.jsx)(`option`,{value:`ALL`,children:`All Difficulties`}),(0,B.jsx)(`option`,{value:`Easy`,children:`Easy`}),(0,B.jsx)(`option`,{value:`Medium`,children:`Medium`}),(0,B.jsx)(`option`,{value:`Hard`,children:`Hard`})]})})]})]}),(0,B.jsx)(`div`,{className:`table-wrapper`,children:(0,B.jsxs)(`table`,{className:`bank-table`,children:[(0,B.jsx)(`thead`,{children:(0,B.jsxs)(`tr`,{children:[(0,B.jsx)(`th`,{className:`col-name`,children:`Question Name`}),(0,B.jsx)(`th`,{className:`col-topic`,children:`Topic`}),(0,B.jsx)(`th`,{className:`col-diff`,children:`Difficulty`}),c?(0,B.jsx)(`th`,{className:`col-history text-center`,children:`Actions`}):o===`ALL`?(0,B.jsx)(`th`,{className:`col-sheet`,children:`Sheets`}):(0,B.jsx)(`th`,{className:`col-history`,children:`History`})]})}),(0,B.jsx)(`tbody`,{children:Me.length>0?Me.map(e=>{let r=t[e.id],i=lt(e);return(0,B.jsxs)(`tr`,{children:[(0,B.jsx)(`td`,{className:`col-name font-semibold`,title:e.name,children:(0,B.jsx)(`a`,{href:ut(e),target:`_blank`,rel:`noopener noreferrer`,className:`q-name-link`,title:e.link?`Open problem page`:`Search problem on Google`,children:e.name})}),(0,B.jsx)(`td`,{className:`col-topic`,children:(0,B.jsx)(`span`,{className:`badge badge-topic`,title:e.topic,children:Ke(e.topic)})}),(0,B.jsx)(`td`,{className:`col-diff`,children:(0,B.jsx)(`span`,{className:`badge badge-${e.difficulty.toLowerCase()}`,children:e.difficulty})}),c?(0,B.jsx)(`td`,{className:`col-history text-center`,children:(0,B.jsxs)(`div`,{className:`edit-mode-actions`,children:[(0,B.jsx)(`button`,{className:`icon-action-btn`,onClick:()=>Ge(e),title:`Edit Question`,children:(0,B.jsx)(ve,{size:15})}),(0,B.jsx)(`button`,{className:`icon-action-btn text-danger`,onClick:()=>Je(e.id),title:`Delete Question`,children:(0,B.jsx)(Ne,{size:15})})]})}):o===`ALL`?(0,B.jsx)(`td`,{className:`col-sheet`,children:(0,B.jsx)(`div`,{className:`sheets-tags-wrapper`,children:i.map(e=>(0,B.jsx)(`button`,{type:`button`,className:`sheet-tag-btn`,onClick:()=>{s(e),b(``)},title:`Filter by ${e}`,children:e},e))})}):(0,B.jsx)(`td`,{className:`col-history`,children:(()=>{let t=dt(e.id,n,r,5),i=Math.max(0,5-t.length),a=[...Array(i).fill({type:`empty`,label:`Not attempted`,date:``}),...t],o=t.length>0?`Recent Outcomes (${t.length} attempt${t.length===1?``:`s`}):\n`+t.map((e,t)=>`${t+1}. ${e.label}${e.date?` (${e.date})`:``}`).join(`
`):`Never attempted`;return(0,B.jsx)(`div`,{className:`history-dots-row`,title:o,children:a.map((e,t)=>(0,B.jsx)(`span`,{className:`history-dot dot-${e.type}`,title:e.type===`empty`?`Never attempted`:`${e.label}${e.date?` (${e.date})`:``}`},t))})})()})]},e.id)}):(0,B.jsx)(`tr`,{children:(0,B.jsx)(`td`,{colSpan:`4`,className:`text-center py-6 text-muted`,children:`No questions match your filter criteria in this view.`})})})]})})]}),ee&&(0,B.jsx)(`div`,{className:`modal-overlay`,onClick:()=>T(!1),children:(0,B.jsxs)(`div`,{className:`modal-card glass-card`,onClick:e=>e.stopPropagation(),children:[(0,B.jsxs)(`div`,{className:`modal-header`,children:[(0,B.jsx)(`h3`,{children:`Create New Sheet`}),(0,B.jsx)(`button`,{className:`close-btn`,onClick:()=>T(!1),children:(0,B.jsx)(Re,{size:18})})]}),(0,B.jsxs)(`form`,{onSubmit:Ue,className:`form-body`,children:[(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Sheet Name *`}),(0,B.jsx)(`input`,{type:`text`,required:!0,value:te,onChange:e=>E(e.target.value),placeholder:`e.g. LeetCode 75, Core CS, SQL Mastery...`,className:`input-field-full`,autoFocus:!0})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Populate with CSV File (Optional)`}),(0,B.jsx)(`input`,{type:`file`,accept:`.csv`,onChange:e=>ne(e.target.files[0]||null),className:`input-field-full`}),(0,B.jsxs)(`span`,{className:`form-subtext`,children:[`Upload a CSV file (schema: `,(0,B.jsx)(`code`,{children:`name, topic, difficulty, link`}),`) to populate questions directly into this sheet (merging duplicate question names automatically).`]})]}),(0,B.jsxs)(`div`,{className:`form-actions`,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>T(!1),children:`Cancel`}),(0,B.jsx)(`button`,{type:`submit`,className:`btn btn-primary`,children:`Create Sheet`})]})]})]})}),A&&(0,B.jsx)(`div`,{className:`modal-overlay`,onClick:()=>j(!1),children:(0,B.jsxs)(`div`,{className:`modal-card glass-card`,onClick:e=>e.stopPropagation(),children:[(0,B.jsxs)(`div`,{className:`modal-header`,children:[(0,B.jsx)(`h3`,{children:re?`Edit Question`:`Add Question`}),(0,B.jsx)(`button`,{className:`close-btn`,onClick:()=>j(!1),children:(0,B.jsx)(Re,{size:18})})]}),(0,B.jsxs)(`form`,{onSubmit:Ze,className:`form-body`,children:[(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Question Name *`}),(0,B.jsx)(`input`,{type:`text`,required:!0,value:P.name,onChange:e=>F({...P,name:e.target.value}),placeholder:`e.g. Set Matrix Zeroes`,className:`input-field-full`})]}),(0,B.jsxs)(`div`,{className:`form-row`,children:[(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Topic`}),(0,B.jsx)(`input`,{type:`text`,value:P.topic,onChange:e=>F({...P,topic:e.target.value}),placeholder:`e.g. Arrays & Hashing`,className:`input-field-full`})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Difficulty`}),(0,B.jsxs)(`select`,{value:P.difficulty,onChange:e=>F({...P,difficulty:e.target.value}),className:`input-field-full`,children:[(0,B.jsx)(`option`,{value:`Easy`,children:`Easy`}),(0,B.jsx)(`option`,{value:`Medium`,children:`Medium`}),(0,B.jsx)(`option`,{value:`Hard`,children:`Hard`})]})]})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Sheet Membership (Select all that apply) *`}),(0,B.jsx)(`div`,{className:`sheet-chips-selector`,children:De.map(e=>{let t=(P.sheets||[]).includes(e);return(0,B.jsxs)(`button`,{type:`button`,className:`sheet-select-chip ${t?`selected`:``}`,onClick:()=>qe(e),children:[t?(0,B.jsx)(ke,{size:14}):(0,B.jsx)(Ae,{size:14}),(0,B.jsx)(`span`,{children:e})]},e)})}),ie?(0,B.jsxs)(`div`,{className:`form-row mt-2`,children:[(0,B.jsx)(`input`,{type:`text`,required:!0,value:I,onChange:e=>se(e.target.value),placeholder:`Enter new sheet name...`,className:`input-field-full`,autoFocus:!0}),(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary text-xs`,onClick:()=>ae(!1),children:`Cancel`})]}):(0,B.jsx)(`button`,{type:`button`,className:`btn-link-action mt-1`,onClick:()=>ae(!0),children:`+ Add to a new sheet...`})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Problem URL / Link`}),(0,B.jsx)(`input`,{type:`url`,value:P.link,onChange:e=>F({...P,link:e.target.value}),placeholder:`https://leetcode.com/problems/...`,className:`input-field-full`})]}),(0,B.jsxs)(`div`,{className:`form-actions`,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>j(!1),children:`Cancel`}),(0,B.jsx)(`button`,{type:`submit`,className:`btn btn-primary`,children:`Save Question`})]})]})]})}),ce&&(0,B.jsx)(`div`,{className:`modal-overlay`,onClick:()=>le(!1),children:(0,B.jsxs)(`div`,{className:`modal-card glass-card`,onClick:e=>e.stopPropagation(),children:[(0,B.jsxs)(`div`,{className:`modal-header`,children:[(0,B.jsx)(`h3`,{children:`Find & Replace`}),(0,B.jsx)(`button`,{className:`close-btn`,onClick:()=>le(!1),children:(0,B.jsx)(Re,{size:18})})]}),(0,B.jsxs)(`form`,{onSubmit:Ve,className:`form-body`,children:[(0,B.jsxs)(`div`,{className:`destination-badge-box`,children:[(0,B.jsx)(`span`,{className:`text-muted font-semibold`,children:`Operating Scope:`}),(0,B.jsx)(`strong`,{className:`text-amber`,children:!R||R===`GLOBAL`||R===`ALL`?`All Questions`:`Sheet "${R}"`})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Target Field`}),(0,B.jsxs)(`select`,{value:fe,onChange:e=>pe(e.target.value),className:`input-field-full`,children:[(0,B.jsx)(`option`,{value:`topic`,children:`Topic`}),(0,B.jsx)(`option`,{value:`sheet`,children:`Sheet Name`}),(0,B.jsx)(`option`,{value:`difficulty`,children:`Difficulty`})]})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Find (Old Value) *`}),(0,B.jsx)(`input`,{type:`text`,required:!0,list:`existing-field-values`,value:he,onChange:e=>ge(e.target.value),placeholder:`e.g. Aray & Hashng`,className:`input-field-full`}),(0,B.jsxs)(`datalist`,{id:`existing-field-values`,children:[fe===`topic`&&je.map(e=>(0,B.jsx)(`option`,{value:e},e)),fe===`sheet`&&De.map(e=>(0,B.jsx)(`option`,{value:e},e)),fe===`difficulty`&&[`Easy`,`Medium`,`Hard`].map(e=>(0,B.jsx)(`option`,{value:e},e))]})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Replace With (New Value) *`}),(0,B.jsx)(`input`,{type:`text`,required:!0,value:_e,onChange:e=>ye(e.target.value),placeholder:`e.g. Arrays & Hashing`,className:`input-field-full`})]}),(0,B.jsxs)(`div`,{className:`match-counter-preview`,children:[(0,B.jsx)(`span`,{className:`text-muted`,children:`Matches Preview:`}),(0,B.jsxs)(`span`,{className:`count-badge ${Fe>0?`badge-match-found`:`badge-match-none`}`,children:[Fe,` question`,Fe===1?``:`s`,` matching`]})]}),(0,B.jsxs)(`div`,{className:`form-actions`,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>le(!1),children:`Cancel`}),(0,B.jsx)(`button`,{type:`submit`,className:`btn btn-primary`,disabled:Fe===0||!he.trim()||!_e.trim(),children:`Apply Replace`})]})]})]})}),(0,B.jsx)(`style`,{children:`
        .bank-container {
          max-width: 1100px;
          margin: 1.5rem auto;
          padding: 2rem;
