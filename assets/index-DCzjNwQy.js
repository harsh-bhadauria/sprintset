...
`&&n!==`\r`&&n!==`\r
`&&(n=`
`);var p=0,m=!1;this.parse=function(s,g,_){if(typeof s!=`string`)throw Error(`Input must be a string`);var v=s.length,y=t.length,b=n.length,x=r.length,C=S(i),w=[],T=[],E=[],D=p=0;if(!s)return I();if(o||!1!==o&&s.indexOf(d)===-1){for(var O=s.split(n),k=0;k<O.length;k++){if(E=O[k],p+=E.length,k!==O.length-1)p+=n.length;else if(_)return I();if(!r||E.substring(0,x)!==r){if(C){if(w=[],ne(E.split(t)),re(),m)return I()}else ne(E.split(t));if(a&&a<=k)return w=w.slice(0,a),I(!0)}}return I()}for(var A=s.indexOf(t,p),j=s.indexOf(n,p),ee=new RegExp(h(f)+h(d),`g`),M=s.indexOf(d,p);;)if(s[p]===d)for(M=p,p++;;){if((M=s.indexOf(d,M+1))===-1)return _||T.push({type:`Quotes`,code:`MissingQuotes`,message:`Quoted field unterminated`,row:w.length,index:p}),P();if(M===v-1)return P(s.substring(p,M).replace(ee,d));if(d===f&&s[M+1]===f)M++;else if(d===f||M===0||s[M-1]!==f){A!==-1&&A<M+1&&(A=s.indexOf(t,M+1));var te=N((j=j!==-1&&j<M+1?s.indexOf(n,M+1):j)===-1?A:Math.min(A,j));if(s.substr(M+1+te,y)===t){E.push(s.substring(p,M).replace(ee,d)),s[p=M+1+te+y]!==d&&(M=s.indexOf(d,p)),A=s.indexOf(t,p),j=s.indexOf(n,p);break}if(te=N(j),s.substring(M+1+te,M+1+te+b)===n){if(E.push(s.substring(p,M).replace(ee,d)),F(M+1+te+b),A=s.indexOf(t,p),M=s.indexOf(d,p),C&&(re(),m))return I();if(a&&w.length>=a)return I(!0);break}T.push({type:`Quotes`,code:`InvalidQuotes`,message:`Trailing quote on quoted field is malformed`,row:w.length,index:p}),M++}}else if(r&&E.length===0&&s.substring(p,p+x)===r){if(j===-1)return I();p=j+b,j=s.indexOf(n,p),A=s.indexOf(t,p)}else if(A!==-1&&(A<j||j===-1))E.push(s.substring(p,A)),p=A+y,A=s.indexOf(t,p);else{if(j===-1)break;if(E.push(s.substring(p,j)),F(j+b),C&&(re(),m))return I();if(a&&w.length>=a)return I(!0)}return P();function ne(e){w.push(e),D=p}function N(e){var t=0;return t=e!==-1&&(e=s.substring(M+1,e))&&e.trim()===``?e.length:t}function P(e){return _||(e===void 0&&(e=s.substring(p)),E.push(e),p=v,ne(E),C&&re()),I()}function F(e){p=e,ne(E),E=[],j=s.indexOf(n,p)}function I(r){if(e.header&&!g&&w.length&&!u){var i=w[0],a=Object.create(null),o=new Set(i);let t=!1;for(let n=0;n<i.length;n++){let r=c(i[n]);if(a[r=S(e.transformHeader)?e.transformHeader(r,n):r]){let e,s=a[r];for(;e=r+`_`+s,s++,o.has(e););o.add(e),i[n]=e,a[r]++,t=!0,(l=l===null?{}:l)[e]=r}else a[r]=1,i[n]=r;o.add(r)}t&&console.warn(`Duplicate headers found and renamed.`),u=!0}return{data:w,errors:T,meta:{delimiter:t,linebreak:n,aborted:m,truncated:!!r,cursor:D+(g||0),renamedHeaders:l}}}function re(){i(I()),w=[],T=[]}},this.abort=function(){m=!0},this.getCharIndex=function(){return p}}function _(e){var t=e.data,n=a[t.workerId],r=!1;if(t.error)n.userError(t.error,t.file);else if(t.results&&t.results.data){var i={abort:function(){r=!0,v(t.workerId,{data:[],errors:[],meta:{aborted:!0}})},pause:y,resume:y};if(S(n.userStep)){for(var o=0;o<t.results.data.length&&(n.userStep({data:t.results.data[o],errors:t.results.errors,meta:t.results.meta},i),!r);o++);delete t.results}else S(n.userChunk)&&(n.userChunk(t.results,i,t.file),delete t.results)}t.finished&&!r&&v(t.workerId,t.results)}function v(e,t){var n=a[e];S(n.userComplete)&&n.userComplete(t),n.terminate(),delete a[e]}function y(){throw Error(`Not implemented.`)}function b(e){if(typeof e!=`object`||!e)return e;var t,n=Array.isArray(e)?[]:{};for(t in e)n[t]=b(e[t]);return n}function x(e,t){return function(){e.apply(t,arguments)}}function S(e){return typeof e==`function`}return s.parse=function(n,r){var i=(r||={}).dynamicTyping||!1;if(S(i)&&(r.dynamicTypingFunction=i,i={}),r.dynamicTyping=i,r.transform=!!S(r.transform)&&r.transform,!r.worker||!s.WORKERS_SUPPORTED)return i=null,s.NODE_STREAM_INPUT,typeof n==`string`?(n=c(n),i=new(r.download?u:f)(r)):!0===n.readable&&S(n.read)&&S(n.on)?i=new p(r):(t.File&&n instanceof File||n instanceof Object)&&(i=new d(r)),i.stream(n);(i=(()=>{var n;return!!s.WORKERS_SUPPORTED&&(n=(()=>{var n=t.URL||t.webkitURL||null,r=e.toString();return s.BLOB_URL||=n.createObjectURL(new Blob([`var global = (function() { if (typeof self !== 'undefined') { return self; } if (typeof window !== 'undefined') { return window; } if (typeof global !== 'undefined') { return global; } return {}; })(); global.IS_PAPA_WORKER=true; `,`(`,r,`)();`],{type:`text/javascript`}))})(),(n=new t.Worker(n)).onmessage=_,n.id=o++,a[n.id]=n)})()).userStep=r.step,i.userChunk=r.chunk,i.userComplete=r.complete,i.userError=r.error,r.step=S(r.step),r.chunk=S(r.chunk),r.complete=S(r.complete),r.error=S(r.error),delete r.worker,i.postMessage({input:n,config:r,workerId:i.id})},s.unparse=function(e,t){var n=!1,r=!0,i=`,`,a=`\r
...
`):`Never attempted`;return(0,B.jsx)(`div`,{className:`history-dots-row`,title:o,children:a.map((e,t)=>(0,B.jsx)(`span`,{className:`history-dot dot-${e.type}`,title:e.type===`empty`?`Never attempted`:`${e.label}${e.date?` (${e.date})`:``}`},t))})})()})]},e.id)}):(0,B.jsx)(`tr`,{children:(0,B.jsx)(`td`,{colSpan:`4`,className:`text-center py-6 text-muted`,children:`No questions match your filter criteria in this view.`})})})]})})]}),T&&(0,Xe.createPortal)((0,B.jsx)(`div`,{className:`modal-overlay`,onClick:()=>E(!1),children:(0,B.jsxs)(`div`,{className:`modal-card glass-card`,onClick:e=>e.stopPropagation(),children:[(0,B.jsxs)(`div`,{className:`modal-header`,children:[(0,B.jsx)(`h3`,{children:`Create New Sheet`}),(0,B.jsx)(`button`,{className:`close-btn`,onClick:()=>E(!1),children:(0,B.jsx)(Ue,{size:18})})]}),(0,B.jsxs)(`form`,{onSubmit:Ke,className:`form-body`,children:[(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Sheet Name *`}),(0,B.jsx)(`input`,{type:`text`,required:!0,value:D,onChange:e=>O(e.target.value),placeholder:`e.g. LeetCode 75, Core CS, SQL Mastery...`,className:`input-field-full`,autoFocus:!0})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Populate with CSV File (Optional)`}),(0,B.jsx)(`input`,{type:`file`,accept:`.csv`,onChange:e=>ee(e.target.files[0]||null),className:`input-field-full`}),(0,B.jsxs)(`span`,{className:`form-subtext`,children:[`Upload a CSV file (schema: `,(0,B.jsx)(`code`,{children:`name, topic, difficulty, link`}),`) to populate questions directly into this sheet (merging duplicate question names automatically).`]})]}),(0,B.jsxs)(`div`,{className:`form-actions`,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>E(!1),children:`Cancel`}),(0,B.jsx)(`button`,{type:`submit`,className:`btn btn-primary`,children:`Create Sheet`})]})]})]})}),document.body),M&&(0,Xe.createPortal)((0,B.jsx)(`div`,{className:`modal-overlay`,onClick:()=>te(!1),children:(0,B.jsxs)(`div`,{className:`modal-card glass-card`,onClick:e=>e.stopPropagation(),children:[(0,B.jsxs)(`div`,{className:`modal-header`,children:[(0,B.jsx)(`h3`,{children:ne?`Edit Question`:`Add Question`}),(0,B.jsx)(`button`,{className:`close-btn`,onClick:()=>te(!1),children:(0,B.jsx)(Ue,{size:18})})]}),(0,B.jsxs)(`form`,{onSubmit:tt,className:`form-body`,children:[(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Question Name *`}),(0,B.jsx)(`input`,{type:`text`,required:!0,value:F.name,onChange:e=>I({...F,name:e.target.value}),placeholder:`e.g. Set Matrix Zeroes`,className:`input-field-full`})]}),(0,B.jsxs)(`div`,{className:`form-row`,children:[(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Topic`}),(0,B.jsx)(`input`,{type:`text`,value:F.topic,onChange:e=>I({...F,topic:e.target.value}),placeholder:`e.g. Arrays & Hashing`,className:`input-field-full`})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Difficulty`}),(0,B.jsxs)(`select`,{value:F.difficulty,onChange:e=>I({...F,difficulty:e.target.value}),className:`input-field-full`,children:[(0,B.jsx)(`option`,{value:`Easy`,children:`Easy`}),(0,B.jsx)(`option`,{value:`Medium`,children:`Medium`}),(0,B.jsx)(`option`,{value:`Hard`,children:`Hard`})]})]})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Sheet Membership (Select all that apply) *`}),(0,B.jsx)(`div`,{className:`sheet-chips-selector`,children:xe.map(e=>{let t=(F.sheets||[]).includes(e);return(0,B.jsxs)(`button`,{type:`button`,className:`sheet-select-chip ${t?`selected`:``}`,onClick:()=>Ye(e),children:[t?(0,B.jsx)(Pe,{size:14}):(0,B.jsx)(Fe,{size:14}),(0,B.jsx)(`span`,{children:e})]},e)})}),re?(0,B.jsxs)(`div`,{className:`form-row mt-2`,children:[(0,B.jsx)(`input`,{type:`text`,required:!0,value:L,onChange:e=>R(e.target.value),placeholder:`Enter new sheet name...`,className:`input-field-full`,autoFocus:!0}),(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary text-xs`,onClick:()=>ie(!1),children:`Cancel`})]}):(0,B.jsx)(`button`,{type:`button`,className:`btn-link-action mt-1`,onClick:()=>ie(!0),children:`+ Add to a new sheet...`})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Problem URL / Link`}),(0,B.jsx)(`input`,{type:`url`,value:F.link,onChange:e=>I({...F,link:e.target.value}),placeholder:`https://leetcode.com/problems/...`,className:`input-field-full`})]}),(0,B.jsxs)(`div`,{className:`form-actions`,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>te(!1),children:`Cancel`}),(0,B.jsx)(`button`,{type:`submit`,className:`btn btn-primary`,children:`Save Question`})]})]})]})}),document.body),se&&(0,Xe.createPortal)((0,B.jsx)(`div`,{className:`modal-overlay`,onClick:()=>ce(!1),children:(0,B.jsxs)(`div`,{className:`modal-card glass-card`,onClick:e=>e.stopPropagation(),children:[(0,B.jsxs)(`div`,{className:`modal-header`,children:[(0,B.jsx)(`h3`,{children:`Find & Replace`}),(0,B.jsx)(`button`,{className:`close-btn`,onClick:()=>ce(!1),children:(0,B.jsx)(Ue,{size:18})})]}),(0,B.jsxs)(`form`,{onSubmit:We,className:`form-body`,children:[(0,B.jsxs)(`div`,{className:`destination-badge-box`,children:[(0,B.jsx)(`span`,{className:`text-muted font-semibold`,children:`Operating Scope:`}),(0,B.jsx)(`strong`,{className:`text-amber`,children:!le||le===`GLOBAL`||le===`ALL`?`All Questions`:`Sheet "${le}"`})]}),(0,B.jsxs)(`div`,{className:`form-group mt-3`,children:[(0,B.jsx)(`label`,{children:`Target Field to Match & Replace`}),(0,B.jsxs)(`select`,{value:de,onChange:e=>z(e.target.value),className:`input-field-full`,children:[(0,B.jsx)(`option`,{value:`topic`,children:`Topic Category`}),(0,B.jsx)(`option`,{value:`sheet`,children:`Sheet Membership`}),(0,B.jsx)(`option`,{value:`difficulty`,children:`Difficulty Level`})]})]}),(0,B.jsxs)(`div`,{className:`form-row mt-3`,children:[(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Find Exact Value`}),(0,B.jsx)(`input`,{type:`text`,required:!0,value:fe,onChange:e=>he(e.target.value),placeholder:`e.g. Array, Binary Trees...`,className:`input-field-full`})]}),(0,B.jsxs)(`div`,{className:`form-group`,children:[(0,B.jsx)(`label`,{children:`Replace With New Value`}),(0,B.jsx)(`input`,{type:`text`,required:!0,value:ge,onChange:e=>ve(e.target.value),placeholder:`e.g. Arrays, Core Trees...`,className:`input-field-full`})]})]}),fe.trim()&&(0,B.jsxs)(`div`,{className:`matching-impact-info mt-2`,children:[(0,B.jsx)(ze,{size:14,className:`text-amber`}),(0,B.jsxs)(`span`,{children:[`Matches `,(0,B.jsx)(`strong`,{children:Ie}),` question`,Ie===1?``:`s`]})]}),(0,B.jsxs)(`div`,{className:`form-actions mt-4`,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>ce(!1),children:`Cancel`}),(0,B.jsx)(`button`,{type:`submit`,className:`btn btn-primary`,disabled:Ie===0||!ge.trim(),children:`Apply Replacement`})]})]})]})}),document.body),(0,B.jsx)(`style`,{children:`
      ...
      `})]})}var dt=[{id:`speedy`,name:`Speedy`,tag:`5 Easy`,quota:{Easy:5,Medium:0,Hard:0}},{id:`steady`,name:`Steady`,tag:`5 Medium`,quota:{Easy:0,Medium:5,Hard:0}},{id:`balanced`,name:`Balanced`,tag:`2E / 2M / 1H`,quota:{Easy:2,Medium:2,Hard:1}},{id:`grind`,name:`Grind`,tag:`1E / 2M / 2H`,quota:{Easy:1,Medium:2,Hard:2}},{id:`gauntlet`,name:`Gauntlet`,tag:`2M / 3H`,quota:{Easy:0,Medium:2,Hard:3}},{id:`custom`,name:`Custom`,tag:`? / ? / ?`,quota:null}];function ft(e,t){let n={Easy:e.Easy||0,Medium:e.Medium||0,Hard:e.Hard||0},r={Easy:t.Easy||0,Medium:t.Medium||0,Hard:t.Hard||0},i=n.Easy+n.Medium+n.Hard,a={Easy:Math.min(n.Easy,r.Easy),Medium:Math.min(n.Medium,r.Medium),Hard:Math.min(n.Hard,r.Hard)},o=i-(a.Easy+a.Medium+a.Hard),s=e=>{if(o<=0)return;let t=r[e]-a[e];if(t>0){let n=Math.min(o,t);a[e]+=n,o-=n}},c=n.Hard-a.Hard,l=n.Easy-a.Easy,u=n.Medium-a.Medium;return c>0&&(s(`Medium`),s(`Easy`)),l>0&&(s(`Medium`),s(`Hard`)),u>0&&(s(`Easy`),s(`Hard`)),o>0&&(s(`Medium`),s(`Easy`),s(`Hard`)),a}function pt({questions:e,settings:t={},onStartSprint:n}){let r=t.timeWeightsByDifficulty||{Easy:4,Medium:8,Hard:15},[i,a]=(0,_.useState)(`balanced`),[o,s]=(0,_.useState)({Easy:2,Medium:2,Hard:1}),[c,l]=(0,_.useState)(!1),u=(0,_.useMemo)(()=>{let t=new Set;return(e||[]).forEach(e=>{ot(e).forEach(e=>t.add(e))}),Array.from(t).sort()},[e]),[d,f]=(0,_.useState)(()=>{try{return localStorage.getItem(`sprintset_last_selected_sheet_v1`)||`ALL`}catch{return`ALL`}}),p=e=>{f(e);try{localStorage.setItem(`sprintset_last_selected_sheet_v1`,e)}catch{}};(0,_.useEffect)(()=>{d!==`ALL`&&u.length>0&&!u.includes(d)&&p(`ALL`)},[u,d]);let m=(0,_.useMemo)(()=>d===`ALL`?e:(e||[]).filter(e=>ot(e).includes(d)),[e,d]),h=(0,_.useMemo)(()=>{let e={Easy:0,Medium:0,Hard:0};return m.forEach(t=>{t.difficulty&&e[t.difficulty]!==void 0&&(e[t.difficulty]+=1)}),e},[m]),g=(0,_.useMemo)(()=>m.length,[m]),v=(0,_.useMemo)(()=>{let e={};return dt.forEach(t=>{if(t.id===`custom`){e.custom={disabled:!1,isAdapted:!1,effectiveQuota:o,displayTag:`? / ? / ?`,reason:``};return}let n=t.quota,r=(n.Easy||0)+(n.Medium||0)+(n.Hard||0);if(g<r)e[t.id]={disabled:!0,isAdapted:!1,effectiveQuota:n,displayTag:t.tag,reason:`Not enough questions in this sheet for this preset (requires ${r} questions, only ${g} available)`};else if(h.Easy>=(n.Easy||0)&&h.Medium>=(n.Medium||0)&&h.Hard>=(n.Hard||0))e[t.id]={disabled:!1,isAdapted:!1,effectiveQuota:n,displayTag:t.tag,reason:``};else{let r=ft(n,h),i=`${r.Easy}E / ${r.Medium}M / ${r.Hard}H`;e[t.id]={disabled:!1,isAdapted:!0,effectiveQuota:r,displayTag:i,reason:`Adapted to match available sheet question counts`}}}),e},[h,g,o]);(0,_.useEffect)(()=>{let e=v[i];if(e&&e.disabled){let e=dt.find(e=>!v[e.id]?.disabled);e&&a(e.id)}},[v,i]);let y=(0,_.useMemo)(()=>{let e=v[i];return e&&!e.disabled?e.effectiveQuota:i===`custom`?o:{Easy:2,Medium:2,Hard:1}},[i,v,o]),b=(y.Easy||0)+(y.Medium||0)+(y.Hard||0),x=(0,_.useMemo)(()=>{let e=y.Easy||0,t=y.Medium||0,n=y.Hard||0,i=e*(r.Easy||4)+t*(r.Medium||8)+n*(r.Hard||15),a=Math.round(i/5)*5;return Math.max(5,a||10)},[y,r]),[S,C]=(0,_.useState)(35),[w,T]=(0,_.useState)(!1);(0,_.useEffect)(()=>{w||C(x)},[x,w]);let E=(0,_.useMemo)(()=>{let e=new Set(m.map(e=>e.topic||`General`));return Array.from(e).sort()},[m]),[D,O]=(0,_.useState)(E);(0,_.useEffect)(()=>{O(E)},[E]);let k=(0,_.useMemo)(()=>m.filter(e=>D.length===0||D.includes(e.topic||`General`)),[m,D]),A=k.length,ee=e=>{D.includes(e)?O(D.filter(t=>t!==e)):O([...D,e])},M=()=>O([...E]),te=()=>O([]),N=()=>{if(b<=0){alert(`Please select at least 1 question for your sprint.`);return}if(A===0){alert(`No questions match your selected sheet and topic filters. Please expand your selection.`);return}let e=Je();n({durationSec:S*60,seed:e,quota:y,totalQuestionsQuota:b,filters:{sheet:d,topics:D,presetId:i},matchingQuestions:k})},F=S%60*6,I=S/60%12*30,re=(0,_.useMemo)(()=>{let e=[];for(let t=0;t<12;t++){let n=(t*30-90)*(Math.PI/180),r=t%3==0,i=r?38:41,a=50+44*Math.cos(n),o=50+44*Math.sin(n),s=50+i*Math.cos(n),c=50+i*Math.sin(n);e.push({key:t,x1:a,y1:o,x2:s,y2:c,isMajor:r})}return e},[]);return(0,B.jsxs)(`div`,{className:`sprint-setup-container glass-card`,children:[(0,B.jsx)(`div`,{className:`setup-header`,children:(0,B.jsxs)(`div`,{className:`setup-title-group`,children:[(0,B.jsx)(`div`,{className:`setup-badge`,children:(0,B.jsx)(We,{size:22,className:`text-amber`})}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`h2`,{className:`setup-title`,children:`Start a DSA Sprint`}),(0,B.jsx)(`p`,{className:`setup-subtitle`,children:`Select a question sheet scope, difficulty preset, adjust duration, and launch.`})]})]})}),(0,B.jsx)(`div`,{className:`sheet-scope-prominent-card glass-card`,children:(0,B.jsxs)(`div`,{className:`sheet-scope-header`,children:[(0,B.jsxs)(`div`,{className:`sheet-scope-title-flex`,children:[(0,B.jsx)(j,{size:20,className:`text-amber`}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`h3`,{className:`sheet-scope-heading`,children:`Question Sheet Scope`}),(0,B.jsx)(`p`,{className:`sheet-scope-subtext`,children:`Select a specific sheet to scope question availability and preset distribution`})]})]}),(0,B.jsx)(`div`,{className:`sheet-scope-dropdown-container`,children:(0,B.jsxs)(`select`,{className:`sheet-scope-prominent-select`,value:d,onChange:e=>p(e.target.value),children:[(0,B.jsxs)(`option`,{value:`ALL`,children:[`All Sheets (`,e.length,` total questions)`]}),u.map(t=>{let n=e.filter(e=>ot(e).includes(t)).length;return(0,B.jsxs)(`option`,{value:t,children:[t,` (`,n,` questions)`]},t)})]})})]})}),(0,B.jsxs)(`div`,{className:`setup-two-col-grid`,children:[(0,B.jsxs)(`div`,{className:`col-left`,children:[(0,B.jsxs)(`label`,{className:`section-label mb-3`,children:[(0,B.jsx)(_e,{size:16}),(0,B.jsxs)(`span`,{children:[`Sprint Distribution (`,b,` questions)`]})]}),(0,B.jsx)(`div`,{className:`square-presets-grid`,children:dt.map(e=>{let t=i===e.id,n=Ye[e.id]||We,{disabled:r,isAdapted:o,displayTag:s,reason:c}=v[e.id]||{},l=`Adapted — ${d===`ALL`?`Current Pool`:d} doesn't have enough questions for the standard ${e.name} quota (${e.tag})`;return(0,B.jsxs)(`button`,{type:`button`,disabled:r,title:r?c:o?l:``,className:`square-preset-card ${t?`selected`:``} ${r?`preset-disabled`:``} ${o?`preset-adapted`:``}`,onClick:()=>{r||a(e.id)},children:[(0,B.jsx)(`div`,{className:`preset-icon-container`,children:(0,B.jsx)(n,{size:30,className:`preset-icon-theme ${t?`icon-selected`:`icon-unselected`}`})}),(0,B.jsxs)(`span`,{className:`preset-name`,children:[e.name,o?`*`:``]}),(0,B.jsx)(`span`,{className:`preset-compact-tag`,children:s})]},e.id)})})]}),(0,B.jsxs)(`div`,{className:`col-right`,children:[(0,B.jsxs)(`div`,{className:`section-header-flex mb-3`,children:[(0,B.jsxs)(`label`,{className:`section-label`,children:[(0,B.jsx)(ie,{size:16}),(0,B.jsx)(`span`,{children:`Sprint Duration`})]}),(0,B.jsxs)(`span`,{className:`suggested-tag-pill`,children:[`Suggested: `,x,` min`]})]}),(0,B.jsx)(`div`,{className:`duration-expanded-panel glass-card`,children:(0,B.jsxs)(`div`,{className:`expanded-clock-body`,children:[(0,B.jsx)(`div`,{className:`clock-graphic-large`,children:(0,B.jsxs)(`svg`,{viewBox:`0 0 100 100`,className:`clock-svg`,children:[(0,B.jsx)(`circle`,{cx:`50`,cy:`50`,r:`45`,className:`clock-face`}),re.map(e=>(0,B.jsx)(`line`,{x1:e.x1,y1:e.y1,x2:e.x2,y2:e.y2,className:e.isMajor?`clock-tick-major`:`clock-tick-minor`},e.key)),(0,B.jsx)(`text`,{x:`50`,y:`19`,className:`clock-numeral-subtle`,textAnchor:`middle`,children:`12`}),(0,B.jsx)(`text`,{x:`83.5`,y:`53`,className:`clock-numeral-subtle`,textAnchor:`middle`,children:`3`}),(0,B.jsx)(`text`,{x:`50`,y:`86.5`,className:`clock-numeral-subtle`,textAnchor:`middle`,children:`6`}),(0,B.jsx)(`text`,{x:`16.5`,y:`53`,className:`clock-numeral-subtle`,textAnchor:`middle`,children:`9`}),(0,B.jsx)(`line`,{x1:`50`,y1:`50`,x2:`50`,y2:`28`,className:`clock-hour-hand`,transform:`rotate(${I} 50 50)`}),(0,B.jsx)(`line`,{x1:`50`,y1:`50`,x2:`50`,y2:`20`,className:`clock-minute-hand`,transform:`rotate(${F} 50 50)`}),(0,B.jsx)(`circle`,{cx:`50`,cy:`50`,r:`4`,className:`clock-center`})]})}),(0,B.jsxs)(`div`,{className:`duration-input-controls`,children:[(0,B.jsxs)(`div`,{className:`input-unit-flex`,children:[(0,B.jsx)(`input`,{type:`number`,min:`1`,max:`300`,value:S,onChange:e=>{C(parseInt(e.target.value,10)||15),T(!0)},className:`duration-input-prominent`}),(0,B.jsx)(`span`,{className:`duration-unit-lbl`,children:`minutes`})]}),w&&(0,B.jsxs)(`button`,{type:`button`,className:`btn-reset-suggested`,onClick:()=>{C(x),T(!1)},children:[`Reset to Suggested (`,x,`m)`]})]})]})})]})]}),i===`custom`&&(0,B.jsxs)(`div`,{className:`custom-steppers-fullrow glass-card`,children:[(0,B.jsx)(`h4`,{className:`stepper-row-title`,children:`Custom Question Distribution`}),(0,B.jsxs)(`div`,{className:`horizontal-steppers-row`,children:[(0,B.jsxs)(`div`,{className:`stepper-item-inline`,children:[(0,B.jsx)(`span`,{className:`badge badge-easy`,children:`Easy`}),(0,B.jsxs)(`div`,{className:`stepper-controls-tight`,children:[(0,B.jsx)(`button`,{type:`button`,className:`stepper-btn`,onClick:()=>s(e=>({...e,Easy:Math.max(0,e.Easy-1)})),children:`-`}),(0,B.jsx)(`input`,{type:`number`,min:`0`,max:`50`,value:o.Easy,onChange:e=>s({...o,Easy:Math.max(0,parseInt(e.target.value,10)||0)}),className:`stepper-input-num`}),(0,B.jsx)(`button`,{type:`button`,className:`stepper-btn`,onClick:()=>s(e=>({...e,Easy:e.Easy+1})),children:`+`})]}),(0,B.jsx)(`span`,{className:`unit-label`,children:`questions`})]}),(0,B.jsxs)(`div`,{className:`stepper-item-inline`,children:[(0,B.jsx)(`span`,{className:`badge badge-medium`,children:`Medium`}),(0,B.jsxs)(`div`,{className:`stepper-controls-tight`,children:[(0,B.jsx)(`button`,{type:`button`,className:`stepper-btn`,onClick:()=>s(e=>({...e,Medium:Math.max(0,e.Medium-1)})),children:`-`}),(0,B.jsx)(`input`,{type:`number`,min:`0`,max:`50`,value:o.Medium,onChange:e=>s({...o,Medium:Math.max(0,parseInt(e.target.value,10)||0)}),className:`stepper-input-num`}),(0,B.jsx)(`button`,{type:`button`,className:`stepper-btn`,onClick:()=>s(e=>({...e,Medium:e.Medium+1})),children:`+`})]}),(0,B.jsx)(`span`,{className:`unit-label`,children:`questions`})]}),(0,B.jsxs)(`div`,{className:`stepper-item-inline`,children:[(0,B.jsx)(`span`,{className:`badge badge-hard`,children:`Hard`}),(0,B.jsxs)(`div`,{className:`stepper-controls-tight`,children:[(0,B.jsx)(`button`,{type:`button`,className:`stepper-btn`,onClick:()=>s(e=>({...e,Hard:Math.max(0,e.Hard-1)})),children:`-`}),(0,B.jsx)(`input`,{type:`number`,min:`0`,max:`50`,value:o.Hard,onChange:e=>s({...o,Hard:Math.max(0,parseInt(e.target.value,10)||0)}),className:`stepper-input-num`}),(0,B.jsx)(`button`,{type:`button`,className:`stepper-btn`,onClick:()=>s(e=>({...e,Hard:e.Hard+1})),children:`+`})]}),(0,B.jsx)(`span`,{className:`unit-label`,children:`questions`})]})]})]}),(0,B.jsx)(`div`,{className:`setup-full-width-topics`,children:(0,B.jsxs)(`section`,{className:`setup-section`,children:[(0,B.jsxs)(`div`,{className:`section-header-flex`,children:[(0,B.jsxs)(`button`,{type:`button`,className:`topics-toggle-btn`,onClick:()=>l(!c),children:[(0,B.jsxs)(`div`,{className:`toggle-left`,children:[(0,B.jsx)(me,{size:16}),(0,B.jsxs)(`span`,{className:`font-semibold`,children:[`Focus Topics (`,D.length,`/`,E.length,` Selected)`]})]}),c?(0,B.jsx)(P,{size:18}):(0,B.jsx)(ne,{size:18})]}),c&&(0,B.jsxs)(`div`,{className:`topic-chip-actions`,children:[(0,B.jsx)(`button`,{type:`button`,className:`btn-chip-action`,onClick:M,children:`Select All`}),(0,B.jsx)(`button`,{type:`button`,className:`btn-chip-action`,onClick:te,children:`Clear`})]})]}),c&&(0,B.jsx)(`div`,{className:`topics-grid-fullwidth mt-3`,children:E.map(e=>{let t=D.includes(e);return(0,B.jsxs)(`button`,{type:`button`,className:`topic-chip ${t?`selected`:``}`,onClick:()=>ee(e),children:[t?(0,B.jsx)(Pe,{size:14}):(0,B.jsx)(Fe,{size:14}),(0,B.jsx)(`span`,{children:Ze(e)})]},e)})})]})}),(0,B.jsxs)(`div`,{className:`setup-footer`,children:[(0,B.jsxs)(`div`,{className:`pool-info`,children:[(0,B.jsx)(`span`,{className:`pool-count`,children:b}),(0,B.jsxs)(`span`,{className:`pool-label`,children:[`questions (`,S,` mins)`]})]}),(0,B.jsxs)(`button`,{className:`btn btn-primary btn-start`,onClick:N,disabled:b<=0||A===0,children:[(0,B.jsx)(we,{size:18}),(0,B.jsx)(`span`,{children:`Start Sprint`})]})]}),(0,B.jsx)(`style`,{children:`
      ...
      `})]})}var mt={never:10,gave_up:8,shaky:5,ok:2,solid:.5};function ht(e,t){let n=t[e];return!n||!n.status&&!n.confidence?mt.never:n.status===`gave_up`?mt.gave_up:n.confidence===`shaky`?mt.shaky:n.confidence===`ok`?mt.ok:n.confidence===`solid`?mt.solid:mt.never}function gt(e,t,n,r){let i=qe(r),a=[],o=new Set;return[`Easy`,`Medium`,`Hard`].forEach(r=>{let s=t[r]||0;s<=0||yt(vt(e.filter(e=>e.difficulty===r&&!o.has(e.id)),s,n,i),i).forEach(e=>{o.add(e.id),a.push(e)})}),a}function _t(e,t,n,r,i){let a=qe(i+Date.now()),o=t.filter(t=>t.difficulty===e&&!n.has(t.id));if(o.length===0){let n=t.filter(t=>t.difficulty===e);return n.length===0?null:n[Math.floor(a()*n.length)]}return vt(o,1,r,a)[0]||o[0]}function vt(e,t,n,r){if(!e||e.length===0)return[];let i=e.map(e=>({...e,weight:ht(e.id,n)})),a=[],o=Math.min(t,i.length);for(let e=0;e<o;e++){let e=i.reduce((e,t)=>e+t.weight,0),t=r()*e,n=0;for(let e=0;e<i.length;e++)if(t-=i[e].weight,t<=0){n=e;break}a.push(i[n]),i.splice(n,1)}return a}function yt(e,t){let n=[...e];for(let e=n.length-1;e>0;e--){let r=Math.floor(t()*(e+1));[n[e],n[r]]=[n[r],n[e]]}return n}function bt({activeSprintState:e,settings:t,allQuestions:n=[],questionStates:r={},onUpdateActiveSprintState:i,onFinishSprint:a}){let{sessionData:o,currentIndex:s=0,attempts:c=0,results:l=[],preCountdownDone:u=!1,questionStartElapsedSec:d=0}=e||{},{durationSec:f,queue:p=[],seed:m,totalPausedMs:h=0,isPaused:g=!1,pauseStartedAtMs:v=null}=o||{},[y,b]=(0,_.useState)(u?0:3),[x,S]=(0,_.useState)(o?.startedAtMs||Date.now());(0,_.useEffect)(()=>{if(y>0){let e=setInterval(()=>{b(t=>t<=1?(clearInterval(e),0):t-1)},750);return()=>clearInterval(e)}if(y===0&&!u){let t=Date.now();S(t),i({...e,preCountdownDone:!0,sessionData:{...o,startedAtMs:t}})}},[y,u]);let C=()=>{if(y>0)return f;let e=0,t=o?.startedAtMs||x;e=g&&v?v-t-h:Date.now()-t-h;let n=Math.floor(e/1e3);return Math.max(0,f-n)},[w,T]=(0,_.useState)(()=>C()),[E,D]=(0,_.useState)(!1),[O,k]=(0,_.useState)(`none`),[j,ee]=(0,_.useState)(!1),[M,ne]=(0,_.useState)(!1),[N,P]=(0,_.useState)(!1),[re,L]=(0,_.useState)(!1),[R,ae]=(0,_.useState)(!1),oe=(0,_.useRef)(!1),ce=(0,_.useRef)(!1),[le,ue]=(0,_.useState)(!1),z=p[s];(0,_.useEffect)(()=>{if(g||y>0)return;let e=setInterval(()=>{let t=C();T(t),t<=300&&t>0&&!oe.current&&(oe.current=!0,P(!0),ae(!0),setTimeout(()=>ae(!1),4e3)),t<=0&&(clearInterval(e),ce.current||(ce.current=!0,L(!0),setTimeout(()=>{L(!1),xe(l,!1)},1200)))},1e3);return()=>clearInterval(e)},[x,o?.startedAtMs,f,h,g,v,y,l]);let fe=()=>{if(g){let t=Date.now()-(v||Date.now());i({...e,sessionData:{...o,isPaused:!1,pauseStartedAtMs:null,totalPausedMs:h+t}})}else i({...e,sessionData:{...o,isPaused:!0,pauseStartedAtMs:Date.now()}})},pe=()=>{let t=c+1;ne(!0),ue(!0),setTimeout(()=>ne(!1),400),setTimeout(()=>ue(!1),500),i({...e,attempts:t})},me=()=>{!z||O!==`none`||(k(`too-easy`),setTimeout(()=>{k(`none`);let t=new Set(p.map(e=>e.id)),a=_t(z.difficulty,n,t,r,m);if(a){let t=[...p];t[s]=a,i({...e,attempts:0,questionStartElapsedSec:Math.floor((Date.now()-(o?.startedAtMs||x)-h)/1e3),sessionData:{...o,queue:t}})}},350))},he=()=>{O===`none`&&(k(`solved`),ee(!0),setTimeout(()=>ee(!1),400),setTimeout(()=>{k(`none`);let t=o?.startedAtMs||x,n=Math.floor((Date.now()-t-h)/1e3),r=Math.max(1,n-(e?.questionStartElapsedSec||0)),i={questionId:z.id,questionName:z.name,questionLink:z.link||``,topic:z.topic,difficulty:z.difficulty,status:`done`,attempts:c,confidence:null,timeSec:r};ve(i)},450))},ge=()=>{O===`none`&&(k(`gave-up`),setTimeout(()=>{k(`none`);let t=o?.startedAtMs||x,n=Math.floor((Date.now()-t-h)/1e3),r=Math.max(1,n-(e?.questionStartElapsedSec||0)),i={questionId:z.id,questionName:z.name,questionLink:z.link||``,topic:z.topic,difficulty:z.difficulty,status:`gave_up`,attempts:c,confidence:null,timeSec:r};ve(i)},400))},ve=t=>{let n=[...l,t];s+1<p.length?i({...e,currentIndex:s+1,attempts:0,results:n,questionStartElapsedSec:Math.floor((Date.now()-(o?.startedAtMs||x)-h)/1e3)}):xe(n)},ye=()=>{xe(l,!0)},xe=(e,n=!1)=>{let r=C(),i=f-r,s=0;e.forEach(e=>{if(e.status===`done`){let n=t.pointsByDifficulty[e.difficulty]||20;s+=n}});let c=p.reduce((e,n)=>e+(t.pointsByDifficulty[n.difficulty]||20),0);a({seed:m,startedAt:new Date(o?.startedAtMs||x).toISOString(),durationSec:f,actualDurationSec:i,results:e,points:s,maxPossiblePoints:c,totalQuota:p.length,isEndedEarly:n})},Se=e=>{let t=Math.floor(e/60),n=e%60;return`${t.toString().padStart(2,`0`)}:${n.toString().padStart(2,`0`)}`},Ce=e=>e&&e.link&&e.link.trim()!==``?e.link:`https://www.google.com/search?q=${encodeURIComponent(`${e?e.name:``} leetcode`)}`,Te=l.reduce((e,n)=>n.status===`done`?e+(t.pointsByDifficulty[n.difficulty]||20):e,0),De=z?t.pointsByDifficulty[z.difficulty]||20:0;return(0,B.jsxs)(`div`,{className:`active-sprint-container`,children:[(0,B.jsxs)(`div`,{className:`unified-sprint-card glass-card ${O===`solved`?`pulse-success-glow`:``} ${O===`too-easy`?`pulse-blue-glow`:``} ${O===`gave-up`?`pulse-red-glow`:``} ${le?`pulse-amber-glow`:``}`,children:[y>0&&(0,B.jsx)(`div`,{className:`pre-countdown-overlay`,children:(0,B.jsxs)(`div`,{className:`pre-countdown-content`,children:[(0,B.jsx)(`span`,{className:`pre-countdown-num`,children:y}),(0,B.jsx)(`span`,{className:`pre-countdown-label`,children:`GET READY`})]})}),O===`solved`&&(0,B.jsx)(`div`,{className:`floating-action-toast toast-solved`,children:(0,B.jsxs)(`span`,{children:[`+`,De,` Pts!`]})}),le&&(0,B.jsx)(`div`,{className:`floating-action-toast toast-wrong`,children:(0,B.jsx)(`span`,{children:`Wrong Attempt`})}),O===`too-easy`&&(0,B.jsx)(`div`,{className:`floating-action-toast toast-easy`,children:(0,B.jsx)(`span`,{children:`Swapped!`})}),O===`gave-up`&&(0,B.jsx)(`div`,{className:`floating-action-toast toast-gaveup`,children:(0,B.jsx)(`span`,{children:`Skipped`})}),re&&(0,B.jsx)(`div`,{className:`times-up-overlay`,children:(0,B.jsxs)(`div`,{className:`times-up-content`,children:[(0,B.jsx)(ie,{size:48,className:`times-up-icon`}),(0,B.jsx)(`span`,{className:`times-up-text`,children:`TIME'S UP`})]})}),R&&(0,B.jsxs)(`div`,{className:`low-time-toast`,children:[(0,B.jsx)(ze,{size:16}),(0,B.jsx)(`span`,{children:`5 minutes remaining!`})]}),(0,B.jsxs)(`div`,{className:`top-control-bar`,children:[(0,B.jsxs)(`div`,{className:`top-left-sprint-metrics`,children:[(0,B.jsxs)(`div`,{className:`sprint-metric-pill`,title:`Sprint Progress`,children:[(0,B.jsx)(_e,{size:15,className:`text-muted flex-shrink-0`}),(0,B.jsxs)(`span`,{children:[`Q `,(0,B.jsx)(`strong`,{children:s+1}),` of `,(0,B.jsx)(`strong`,{children:p.length})]})]}),(0,B.jsxs)(`div`,{className:`sprint-metric-pill pts-pill-styled`,title:`Session Points Earned`,children:[(0,B.jsx)(A,{size:16,className:`text-amber flex-shrink-0`}),(0,B.jsxs)(`strong`,{className:`text-amber ${j?`counter-tween-pop`:``}`,children:[`+`,Te,` pts`]})]})]}),(0,B.jsxs)(`div`,{className:`top-icon-controls`,children:[(0,B.jsx)(`button`,{className:`icon-btn-ctrl ${g?`btn-paused`:``}`,onClick:fe,title:g?`Resume Sprint`:`Pause Sprint`,children:g?(0,B.jsx)(we,{size:16}):(0,B.jsx)(be,{size:16})}),(0,B.jsx)(`button`,{className:`icon-btn-ctrl btn-stop-danger`,onClick:()=>D(!0),title:`End Sprint Early`,children:(0,B.jsx)(Fe,{size:14})})]})]}),(0,B.jsxs)(`div`,{className:`sprint-middle-zone`,children:[(0,B.jsx)(`div`,{className:`ringless-timer-centered`,children:(0,B.jsx)(`div`,{className:`time-display-massive-focal ${g?`timer-paused-blink`:``} ${N&&!g?`timer-low-time`:``} ${re?`timer-times-up`:``}`,children:Se(w)})}),z?(0,B.jsxs)(`div`,{className:`divider-question-wrapper`,children:[(0,B.jsx)(`hr`,{className:`timer-question-divider`}),(0,B.jsx)(`h2`,{className:`unified-question-title`,children:z.name}),(0,B.jsxs)(`div`,{className:`per-question-meta-row`,children:[(0,B.jsxs)(`a`,{href:Ce(z),target:`_blank`,rel:`noopener noreferrer`,className:`per-q-pill link-per-q-neutral`,title:z.link?`Open Problem Page`:`Search Problem on Google`,children:[(0,B.jsx)(se,{size:13,className:`text-muted`}),(0,B.jsx)(`span`,{className:`text-secondary font-semibold`,children:`Link`})]}),(0,B.jsx)(`span`,{className:`dot-sep`,children:`•`}),(0,B.jsxs)(`div`,{className:`per-q-pill pts-per-q`,children:[(0,B.jsx)(We,{size:13,className:`text-amber`}),(0,B.jsx)(`span`,{children:(0,B.jsxs)(`strong`,{className:`text-gold`,children:[`+`,De,` pts`]})})]}),(0,B.jsx)(`span`,{className:`dot-sep`,children:`•`}),(0,B.jsxs)(`div`,{className:`per-q-pill attempts-per-q`,children:[(0,B.jsx)(ke,{size:13,className:`text-muted`}),(0,B.jsxs)(`span`,{children:[`Attempts: `,(0,B.jsx)(`strong`,{className:`text-primary ${M?`counter-tween-pop`:``}`,children:c+1})]})]})]})]}):(0,B.jsxs)(`div`,{className:`empty-state py-8`,children:[(0,B.jsx)(`h3`,{children:`Sprint Queue Complete!`}),(0,B.jsx)(`button`,{className:`btn btn-primary mt-4`,onClick:ye,children:`View Sprint Summary`})]})]}),z&&(0,B.jsxs)(`div`,{className:`sprint-bottom-actions`,children:[(0,B.jsx)(`div`,{className:`primary-done-wrapper`,children:(0,B.jsxs)(`button`,{className:`btn-done-primary ${O===`solved`?`btn-anim-flash`:``}`,onClick:he,disabled:O!==`none`||g,children:[O===`solved`?(0,B.jsx)(te,{size:36,className:`check-anim-scale`}):(0,B.jsx)(I,{size:26}),(0,B.jsx)(`span`,{children:O===`solved`?`Solved!`:`Solved`})]})}),(0,B.jsxs)(`div`,{className:`secondary-actions-compact-row`,children:[(0,B.jsxs)(`button`,{className:`compact-sec-btn attempt-btn ${le?`btn-flash-amber`:``}`,onClick:pe,disabled:g,title:`Record an incorrect submission (+1 attempt)`,children:[(0,B.jsx)(F,{size:14}),(0,B.jsx)(`span`,{children:`+1 Wrong`})]}),(0,B.jsxs)(`button`,{className:`compact-sec-btn easy-btn`,onClick:me,disabled:g,title:`Pull a replacement question for this slot`,children:[(0,B.jsx)(Ee,{size:14}),(0,B.jsx)(`span`,{children:`Too Easy`})]}),(0,B.jsxs)(`button`,{className:`compact-sec-btn gaveup-btn`,onClick:ge,disabled:g,title:`Gave up / Couldn't solve`,children:[(0,B.jsx)(de,{size:14}),(0,B.jsx)(`span`,{children:`Gave Up`})]})]})]})]}),E&&(0,B.jsx)(`div`,{className:`modal-overlay`,onClick:()=>D(!1),children:(0,B.jsxs)(`div`,{className:`modal-card glass-card confirm-modal`,onClick:e=>e.stopPropagation(),children:[(0,B.jsxs)(`div`,{className:`confirm-header`,children:[(0,B.jsx)(ze,{size:24,className:`text-amber`}),(0,B.jsx)(`h3`,{children:`End Sprint Early?`})]}),(0,B.jsx)(`p`,{className:`confirm-desc`,children:`Your current progress and points earned in this sprint will be saved.`}),(0,B.jsxs)(`div`,{className:`confirm-actions`,children:[(0,B.jsx)(`button`,{className:`btn btn-secondary`,onClick:()=>D(!1),children:`Cancel`}),(0,B.jsx)(`button`,{className:`btn btn-danger`,onClick:ye,children:`End Sprint`})]})]})}),(0,B.jsx)(`style`,{children:`
...
`).filter(Boolean);for(let e=r.length-1;e>=0;e--)try{let t=JSON.parse(r[e]);if(t&&t.event===`message`){if(t.attachment&&t.attachment.url){let e=await fetch(t.attachment.url);if(e.ok){let t=await e.json();if(t&&typeof t==`object`)return t}}else if(t.message){let e=JSON.parse(t.message);if(e&&typeof e==`object`)return e}}}catch{}}catch(t){console.warn(`Cloud Pull failed on ${e}, trying fallback...`,t)}return null}function Lt(e,t=100,n=``){let r=Math.floor(e/(t||100)),i=(n||``).trim().toUpperCase();return`veto://claim-reward?points=${e}&minutes=${r}&syncKey=${encodeURIComponent(i)}`}function Rt({settings:e,questions:t=[],sessions:n=[],state:r,onSaveSettings:i,onImportJSON:a,onImportCSV:o,onResetData:s,onForceUpload:c,onStateImported:l,onResetAllData:u,onUpdateQuestions:d}){let f=e||r?.settings||{},p=t.length>0?t:r?.questions||[],m=n.length>0?n:r?.sessions||[],h=f.pointsByDifficulty?.Easy||200,g=f.pointsByDifficulty?.Medium||500,v=f.pointsByDifficulty?.Hard||1e3,y=f.timeWeightsByDifficulty?.Easy||4,b=f.timeWeightsByDifficulty?.Medium||8,x=f.timeWeightsByDifficulty?.Hard||15,[S,C]=(0,_.useState)(h),[w,T]=(0,_.useState)(g),[E,D]=(0,_.useState)(v),[O,k]=(0,_.useState)(y),[A,j]=(0,_.useState)(b),[ee,M]=(0,_.useState)(x),[ne,N]=(0,_.useState)(``),[P,I]=(0,_.useState)(!1),[re,ie]=(0,_.useState)(f.syncKey||``);(0,_.useEffect)(()=>{C(h),T(g),D(v),k(y),j(b),M(x),ie(f.syncKey||``)},[h,g,v,y,b,x,f.syncKey]);let L=parseInt(S,10)!==h||parseInt(w,10)!==g||parseInt(E,10)!==v||parseInt(O,10)!==y||parseInt(A,10)!==b||parseInt(ee,10)!==x,oe=e=>{e&&e.preventDefault(),i&&i({...f,pointsByDifficulty:{Easy:parseInt(S,10)||200,Medium:parseInt(w,10)||500,Hard:parseInt(E,10)||1e3},timeWeightsByDifficulty:{Easy:parseInt(O,10)||4,Medium:parseInt(A,10)||8,Hard:parseInt(ee,10)||15}}),N(`Settings saved!`),setTimeout(()=>N(``),2500)},se=()=>{C(h),T(g),D(v),k(y),j(b),M(x)},de=e=>{let t=e.target.files[0];t&&Mt(t,e=>{a?a(e):l&&l(e),alert(`Data backup successfully imported!`)},e=>alert(e))},z=e=>{let t=e.target.files[0];t&&nt(t,e=>{if(e.length===0){alert(`No valid question rows found in CSV.`);return}o?o(e):d&&d(e),alert(`Successfully loaded ${e.length} questions from CSV!`)})},fe=()=>{jt(r||{questions:p,sessions:m,settings:f})},pe=()=>{s?s():u&&u()},me=[{id:`sunset`,name:`Sunset Ember`,primary:`#f97316`,secondary:`#ea580c`},{id:`emerald`,name:`Cyber Emerald`,primary:`#10b981`,secondary:`#059669`},{id:`violet`,name:`Cosmic Purple`,primary:`#8b5cf6`,secondary:`#7c3aed`},{id:`electric-blue`,name:`Electric Blue`,primary:`#0ea5e9`,secondary:`#0284c7`},{id:`rose`,name:`Neon Rose`,primary:`#f43f5e`,secondary:`#e11d48`}],he=f.palette||`sunset`,ge=me.find(e=>e.id===he)||me[0];return(0,B.jsxs)(`div`,{className:`settings-container glass-card`,children:[(0,B.jsxs)(`div`,{className:`settings-header`,children:[(0,B.jsxs)(`div`,{children:[(0,B.jsxs)(`h2`,{className:`settings-title`,children:[(0,B.jsx)(Me,{size:22,className:`text-amber`}),(0,B.jsx)(`span`,{children:`App Settings`})]}),(0,B.jsx)(`p`,{className:`settings-subtitle`,children:`Customize scoring points, sprint time weights, accent theme palettes, and data backups.`})]}),(0,B.jsx)(`div`,{className:`settings-header-actions`,children:(0,B.jsxs)(`button`,{type:`button`,className:`btn btn-secondary`,onClick:()=>{window.confirm(`Reset scoring points, sprint weights, and theme palette back to defaults?`)&&(i&&i({palette:`sunset`,pointsByDifficulty:{Easy:10,Medium:20,Hard:30},timeWeightsByDifficulty:{Easy:4,Medium:8,Hard:15}}),C(10),T(20),D(30),k(4),j(8),M(15),N(`Reset settings to defaults!`),setTimeout(()=>N(``),2500))},children:[(0,B.jsx)(ke,{size:15}),(0,B.jsx)(`span`,{children:`Reset Defaults`})]})})]}),L&&(0,B.jsxs)(`div`,{className:`unsaved-banner`,children:[(0,B.jsxs)(`div`,{className:`unsaved-banner-content`,children:[(0,B.jsx)(F,{size:18,className:`text-amber`}),(0,B.jsx)(`span`,{children:`You have unsaved changes to scoring or sprint duration weights!`})]}),(0,B.jsxs)(`div`,{className:`unsaved-actions`,children:[(0,B.jsx)(`button`,{className:`btn btn-secondary btn-sm`,onClick:se,children:`Discard`}),(0,B.jsxs)(`button`,{className:`btn btn-primary btn-sm`,onClick:oe,children:[(0,B.jsx)(Ae,{size:14}),(0,B.jsx)(`span`,{children:`Save Changes`})]})]})]}),ne&&(0,B.jsxs)(`div`,{className:`settings-float-toast`,children:[(0,B.jsx)(`span`,{children:`✓`}),(0,B.jsx)(`span`,{children:ne})]}),(0,B.jsxs)(`div`,{className:`settings-form`,children:[(0,B.jsx)(`section`,{className:`settings-stacked-section`,children:(0,B.jsxs)(`div`,{className:`setting-single-line-row`,children:[(0,B.jsxs)(`div`,{className:`setting-label-col`,children:[(0,B.jsx)(`h3`,{className:`setting-heading`,children:`Accent Theme Palette`}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Select your preferred accent color scheme for Sprintset`})]}),(0,B.jsxs)(`div`,{className:`palette-dropdown-row`,children:[(0,B.jsx)(`span`,{className:`swatch-color-dot`,style:{background:`linear-gradient(135deg, ${ge.primary} 0%, ${ge.secondary} 100%)`}}),(0,B.jsx)(`select`,{className:`palette-select`,value:he,onChange:e=>{let t=me.find(t=>t.id===e.target.value);i&&t&&(i({...f,palette:t.id}),N(`Switched to ${t.name}!`),setTimeout(()=>N(``),1800))},children:me.map(e=>(0,B.jsx)(`option`,{value:e.id,children:e.name},e.id))})]})]})}),(0,B.jsx)(`section`,{className:`settings-stacked-section`,children:(0,B.jsxs)(`div`,{className:`setting-single-line-row`,children:[(0,B.jsxs)(`div`,{className:`setting-label-col`,children:[(0,B.jsx)(`h3`,{className:`setting-heading`,children:`Scoring Configuration`}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Points awarded when a problem is marked Solved`})]}),(0,B.jsxs)(`div`,{className:`setting-controls-right`,children:[(0,B.jsxs)(`div`,{className:`pts-box`,children:[(0,B.jsx)(`span`,{className:`badge badge-easy`,children:`Easy`}),(0,B.jsx)(`input`,{type:`number`,min:`1`,max:`500`,value:S,onChange:e=>C(e.target.value),className:`input-num-tight`}),(0,B.jsx)(`span`,{className:`unit-text`,children:`pts`})]}),(0,B.jsxs)(`div`,{className:`pts-box`,children:[(0,B.jsx)(`span`,{className:`badge badge-medium`,children:`Medium`}),(0,B.jsx)(`input`,{type:`number`,min:`1`,max:`500`,value:w,onChange:e=>T(e.target.value),className:`input-num-tight`}),(0,B.jsx)(`span`,{className:`unit-text`,children:`pts`})]}),(0,B.jsxs)(`div`,{className:`pts-box`,children:[(0,B.jsx)(`span`,{className:`badge badge-hard`,children:`Hard`}),(0,B.jsx)(`input`,{type:`number`,min:`1`,max:`500`,value:E,onChange:e=>D(e.target.value),className:`input-num-tight`}),(0,B.jsx)(`span`,{className:`unit-text`,children:`pts`})]})]})]})}),(0,B.jsx)(`section`,{className:`settings-stacked-section`,children:(0,B.jsxs)(`div`,{className:`setting-single-line-row`,children:[(0,B.jsxs)(`div`,{className:`setting-label-col`,children:[(0,B.jsx)(`h3`,{className:`setting-heading`,children:`Duration Suggestion Weights`}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Base minutes per question used to calculate suggested sprint time`})]}),(0,B.jsxs)(`div`,{className:`setting-controls-right`,children:[(0,B.jsxs)(`div`,{className:`pts-box`,children:[(0,B.jsx)(`span`,{className:`badge badge-easy`,children:`Easy`}),(0,B.jsx)(`input`,{type:`number`,min:`1`,max:`60`,value:O,onChange:e=>k(e.target.value),className:`input-num-tight`}),(0,B.jsx)(`span`,{className:`unit-text`,children:`m/q`})]}),(0,B.jsxs)(`div`,{className:`pts-box`,children:[(0,B.jsx)(`span`,{className:`badge badge-medium`,children:`Medium`}),(0,B.jsx)(`input`,{type:`number`,min:`1`,max:`60`,value:A,onChange:e=>j(e.target.value),className:`input-num-tight`}),(0,B.jsx)(`span`,{className:`unit-text`,children:`m/q`})]}),(0,B.jsxs)(`div`,{className:`pts-box`,children:[(0,B.jsx)(`span`,{className:`badge badge-hard`,children:`Hard`}),(0,B.jsx)(`input`,{type:`number`,min:`1`,max:`60`,value:ee,onChange:e=>M(e.target.value),className:`input-num-tight`}),(0,B.jsx)(`span`,{className:`unit-text`,children:`m/q`})]})]})]})})]}),(0,B.jsxs)(`section`,{className:`settings-stacked-section`,children:[(0,B.jsxs)(`div`,{className:`setting-single-line-row`,children:[(0,B.jsxs)(`div`,{className:`setting-label-col`,children:[(0,B.jsx)(`h3`,{className:`setting-heading`,children:`Data & Progress Snapshot`}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Export JSON backup or load saved progress snapshot`})]}),(0,B.jsxs)(`div`,{className:`button-group-side`,children:[(0,B.jsxs)(`button`,{className:`btn btn-secondary btn-sm`,onClick:fe,children:[(0,B.jsx)(He,{size:14}),(0,B.jsx)(`span`,{children:`Export JSON`})]}),(0,B.jsxs)(`label`,{className:`btn btn-secondary btn-sm cursor-pointer`,children:[(0,B.jsx)(ae,{size:14}),(0,B.jsx)(`span`,{children:`Import JSON`}),(0,B.jsx)(`input`,{type:`file`,accept:`.json`,onChange:de,style:{display:`none`}})]}),c&&(0,B.jsxs)(`button`,{className:`btn btn-primary btn-sm ml-2`,onClick:c,children:[(0,B.jsx)(Ee,{size:14}),(0,B.jsx)(`span`,{children:`Force Upload State`})]})]})]}),(0,B.jsxs)(`div`,{className:`setting-single-line-row mt-3`,children:[(0,B.jsxs)(`div`,{className:`setting-label-col`,children:[(0,B.jsx)(`h3`,{className:`setting-heading`,children:`CSV Question Bank`}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Export or import custom spreadsheet question bank`})]}),(0,B.jsxs)(`div`,{className:`button-group-side`,children:[(0,B.jsxs)(`button`,{className:`btn btn-secondary btn-sm`,onClick:()=>rt(p),children:[(0,B.jsx)(ue,{size:14}),(0,B.jsx)(`span`,{children:`Export CSV`})]}),(0,B.jsxs)(`label`,{className:`btn btn-secondary btn-sm cursor-pointer`,children:[(0,B.jsx)(R,{size:14}),(0,B.jsx)(`span`,{children:`Import CSV`}),(0,B.jsx)(`input`,{type:`file`,accept:`.csv`,onChange:z,style:{display:`none`}})]})]})]})]}),(0,B.jsx)(`section`,{className:`settings-stacked-section`,children:(0,B.jsxs)(`div`,{className:`setting-single-line-row`,children:[(0,B.jsxs)(`div`,{className:`setting-label-col`,children:[(0,B.jsxs)(`span`,{className:`text-sm font-bold text-sky-500 flex items-center gap-1 mb-1`,children:[(0,B.jsx)(ve,{size:14,className:`text-sky-500`}),` Private Cloud Sync Key`]}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Secret passphrase used to securely link your laptop and phone profile data`})]}),(0,B.jsxs)(`div`,{className:`sync-key-settings-input`,style:{display:`flex`,alignItems:`center`},children:[(0,B.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,background:`var(--bg-input)`,border:`1.5px solid var(--border-subtle)`,borderRadius:`var(--radius-md)`,overflow:`hidden`},children:[(0,B.jsx)(`input`,{type:P?`text`:`password`,value:re,onChange:e=>ie(e.target.value.toUpperCase()),className:`text-center font-mono font-bold uppercase`,style:{width:`150px`,background:`transparent`,border:`none`,padding:`0.45rem`,color:`var(--text-primary)`,outline:`none`},placeholder:`SHADOW-PAW-482`}),(0,B.jsx)(`button`,{type:`button`,onClick:()=>I(!P),title:P?`Hide Key`:`Reveal Key`,style:{background:`transparent`,border:`none`,cursor:`pointer`,padding:`0 0.6rem 0 0.2rem`,color:`var(--text-muted)`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:P?(0,B.jsx)(ce,{size:16}):(0,B.jsx)(le,{size:16})})]}),re!==(f.syncKey||``)&&(0,B.jsx)(`button`,{type:`button`,className:`btn btn-primary p-2`,style:{marginLeft:`0.75rem`,display:`flex`,alignItems:`center`,justifyContent:`center`},onClick:()=>{i({...f,syncKey:re}),N(`Sync Key updated!`),setTimeout(()=>N(``),1800)},title:`Save New Sync Key`,children:(0,B.jsx)(te,{size:16})})]})]})}),(0,B.jsx)(`section`,{className:`settings-stacked-section veto-section-card`,children:(0,B.jsxs)(`div`,{className:`setting-single-line-row`,children:[(0,B.jsxs)(`div`,{className:`setting-label-col`,children:[(0,B.jsxs)(`h3`,{className:`setting-heading flex items-center gap-2`,children:[(0,B.jsx)(xe,{size:16,className:`text-amber`}),` Veto Integration`]}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Earn screen time in Veto's Time Bank when you complete DSA sprints`})]}),(0,B.jsx)(`div`,{className:`flex items-center gap-3`,children:(0,B.jsxs)(`label`,{className:`toggle-switch-label`,children:[(0,B.jsx)(`input`,{type:`checkbox`,checked:!!f.vetoEnabled,onChange:e=>{i({...f,vetoEnabled:e.target.checked})}}),(0,B.jsx)(`span`,{className:`toggle-slider`})]})})]})}),(0,B.jsxs)(`section`,{className:`settings-stacked-section danger-stacked mt-4`,children:[(0,B.jsxs)(`div`,{className:`danger-zone-header`,style:{marginBottom:`1.25rem`},children:[(0,B.jsx)(`h3`,{className:`setting-heading font-bold`,style:{color:`#ef4444`},children:`Danger Zone`}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Irreversible destructive actions for local storage and progress`})]}),(0,B.jsxs)(`div`,{className:`setting-single-line-row danger-row-bg`,children:[(0,B.jsxs)(`div`,{className:`setting-label-col`,children:[(0,B.jsx)(`h3`,{className:`setting-heading text-danger`,children:`Reset All Local Data`}),(0,B.jsx)(`p`,{className:`setting-subtext`,children:`Irreversibly wipe saved sessions and local question states`})]}),(0,B.jsxs)(`button`,{className:`btn btn-danger btn-sm`,onClick:pe,children:[(0,B.jsx)(Re,{size:14}),(0,B.jsx)(`span`,{children:`Reset All Data`})]})]})]}),(0,B.jsx)(`style`,{children:`
      ...
      `})]})}function zt({isOpen:e,onClose:t,unclaimedPoints:n=0,syncKey:r=``,onUpdateSyncKey:i,onClaimPoints:a,onSyncCloud:o}){let[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)(!1),[d,f]=(0,_.useState)(r||``),[p,m]=(0,_.useState)(!1),[h,g]=(0,_.useState)(!1);if(!e)return null;let v=(r||``).toUpperCase(),y=Math.floor(n/100),b=Lt(n,100,v);return(0,Xe.createPortal)((0,B.jsx)(`div`,{className:`modal-overlay`,onClick:t,children:(0,B.jsxs)(`div`,{className:`modal-card glass-card veto-modal-card`,onClick:e=>e.stopPropagation(),children:[(0,B.jsxs)(`div`,{className:`modal-header`,children:[(0,B.jsxs)(`div`,{className:`veto-title-group`,children:[(0,B.jsx)(`div`,{className:`veto-icon-badge`,children:(0,B.jsx)(xe,{size:22,className:`text-amber`})}),(0,B.jsxs)(`div`,{children:[(0,B.jsx)(`h3`,{children:`Veto Time Bank Rewards`}),(0,B.jsx)(`p`,{style:{fontSize:`0.75rem`,color:`var(--text-muted)`,opacity:.75,maxWidth:`280px`,lineHeight:`1.3`,marginTop:`0.35rem`,fontWeight:500},children:`Convert your hard-earned focus points into guilt-free screen time on your phone.`})]})]}),(0,B.jsx)(`button`,{className:`close-btn`,onClick:t,children:(0,B.jsx)(Ue,{size:18})})]}),(0,B.jsxs)(`div`,{className:`veto-body`,children:[(0,B.jsxs)(`div`,{className:`veto-stats-grid`,children:[(0,B.jsxs)(`div`,{className:`veto-stat-card`,children:[(0,B.jsx)(`div`,{className:`stat-icon-wrapper`,children:(0,B.jsx)(We,{size:20,className:`text-amber`})}),(0,B.jsx)(`span`,{className:`stat-label`,children:`Unclaimed Points`}),(0,B.jsx)(`span`,{className:`stat-value text-amber`,children:n.toLocaleString()})]}),(0,B.jsxs)(`div`,{className:`veto-stat-card`,children:[(0,B.jsx)(`div`,{className:`stat-icon-wrapper`,children:(0,B.jsx)(ie,{size:20,className:`text-emerald`})}),(0,B.jsx)(`span`,{className:`stat-label`,children:`Veto Time Credit`}),(0,B.jsxs)(`span`,{className:`stat-value text-emerald`,children:[`+`,y,` min`]})]})]}),(0,B.jsxs)(`div`,{className:`veto-actions`,style:{marginTop:`1.25rem`},children:[(0,B.jsx)(`button`,{type:`button`,className:`btn btn-claim-veto full-width`,onClick:()=>{window.location.href=b,a&&a(n)},disabled:n<=0,style:{padding:`1.25rem 1.5rem`,fontSize:`1.15rem`,fontWeight:800,background:`rgb(var(--accent-rgb))`,border:`none`,boxShadow:`0 4px 14px 0 rgba(var(--accent-rgb), 0.4)`,color:`#ffffff`,textTransform:`uppercase`,letterSpacing:`1px`,transition:`all 0.2s ease`,borderRadius:`var(--radius-lg)`},onMouseEnter:e=>{e.currentTarget.style.boxShadow=`0 6px 20px rgba(var(--accent-rgb), 0.65)`,e.currentTarget.style.transform=`translateY(-2px)`},onMouseLeave:e=>{e.currentTarget.style.boxShadow=`0 4px 14px 0 rgba(var(--accent-rgb), 0.4)`,e.currentTarget.style.transform=`translateY(0)`},children:(0,B.jsx)(`span`,{children:`Transfer to Veto`})}),(0,B.jsxs)(`div`,{className:`secondary-veto-actions`,children:[(0,B.jsxs)(`button`,{type:`button`,className:`btn btn-secondary-veto btn-copy-link ${p?`copied`:``}`,onClick:()=>{navigator.clipboard.writeText(b),m(!0),setTimeout(()=>m(!1),2e3)},children:[(0,B.jsx)(L,{size:15}),(0,B.jsx)(`span`,{children:p?`Copied Deep Link!`:`Copy Claim Link`})]}),(0,B.jsxs)(`button`,{type:`button`,className:`btn btn-secondary-veto btn-sync-veto ${h?`syncing`:``}`,onClick:async()=>{g(!0),o&&await o(),setTimeout(()=>g(!1),800)},disabled:h,children:[(0,B.jsx)(Ee,{size:15,className:h?`sync-spin`:``}),(0,B.jsx)(`span`,{children:h?`Syncing...`:`Sync Cloud`})]})]})]})]})]})}),document.body)}function Bt(){let[e,t]=(0,_.useState)(()=>Dt()),[n,r]=(0,_.useState)(`sprint`),[i,a]=(0,_.useState)(!1),[o,s]=(0,_.useState)(()=>At()),[c,l]=(0,_.useState)(null);(0,_.useEffect)(()=>{Ot(e)},[e]),(0,_.useEffect)(()=>{e.settings&&(e.settings.theme&&document.documentElement.setAttribute(`data-theme`,e.settings.theme),e.settings.palette?document.documentElement.setAttribute(`data-palette`,e.settings.palette):document.documentElement.removeAttribute(`data-palette`))},[e.settings]),(0,_.useEffect)(()=>{kt(o)},[o]);let[u,d]=(0,_.useState)(null),[f,p]=(0,_.useState)(!1),m=(0,_.useMemo)(()=>(e.sessions||[]).reduce((e,t)=>e+(t.points||0),0),[e.sessions]),h=e.claimedVetoPoints||0,g=Math.max(0,m-h),v=u===null?g:Math.max(u,g),y=Math.floor(v/100),b=e.settings?.syncKey||``,x=(e,t)=>{let n={...e};if(t.settings){let r=e.settings?.updatedAtMs||0;((t.settings.updatedAtMs||0)>=r||!e.settings?.updatedAtMs)&&(n.settings={...e.settings,...t.settings})}if(t.claimedVetoPoints!==void 0&&t.claimedVetoPoints>(e.claimedVetoPoints||0)&&(n.claimedVetoPoints=t.claimedVetoPoints),t.sessions&&Array.isArray(t.sessions)){let r=new Set((e.sessions||[]).map(e=>e.id)),i=t.sessions.filter(e=>!r.has(e.id));i.length>0&&(n.sessions=[...e.sessions||[],...i].sort((e,t)=>new Date(e.startedAt).getTime()-new Date(t.startedAt).getTime()))}if(t.questionStates){let r={...e.questionStates||{}};Object.keys(t.questionStates).forEach(e=>{let n=t.questionStates[e],i=r[e];(!i||new Date(n.lastAttemptedAt).getTime()>new Date(i.lastAttemptedAt).getTime())&&(r[e]=n)}),n.questionStates=r}if(t.questions&&Array.isArray(t.questions)){let r=new Set((e.questions||[]).map(e=>e.id)),i=t.questions.filter(e=>!r.has(e.id));i.length>0&&(n.questions=[...e.questions||[],...i])}return n},[S,C]=(0,_.useState)(!1);(0,_.useEffect)(()=>{if(!b||!b.trim()){C(!0);return}p(!0),It(b).then(async n=>{let r=e;n&&(r=x(e,n),t(r),n.unclaimedVetoPoints!==void 0&&d(n.unclaimedVetoPoints));let i=(r.sessions||[]).reduce((e,t)=>e+(t.points||0),0),a=r.claimedVetoPoints||0,o=Math.max(0,i-a);await Ft(b,{...r,unclaimedVetoPoints:o}),p(!1),C(!0)})},[b]);let w=(0,_.useRef)(!0);(0,_.useEffect)(()=>{if(w.current){w.current=!1;return}!S||!b||!b.trim()||(async()=>{p(!0),await Ft(b,{...e,unclaimedVetoPoints:g}),p(!1)})()},[S,e.sessions?.length,e.claimedVetoPoints,e.settings?.updatedAtMs]);let T=(0,_.useRef)(e),E=(0,_.useRef)(b),D=(0,_.useRef)(u);(0,_.useEffect)(()=>{T.current=e,E.current=b,D.current=u},[e,b,u]),(0,_.useEffect)(()=>{let e=()=>{if(document.visibilityState===`hidden`||document.visibilityState===`unloaded`){let e=T.current,t=E.current,n=D.current,r=(e.sessions||[]).reduce((e,t)=>e+(t.points||0),0),i=e.claimedVetoPoints||0,a=Math.max(0,r-i),o=n===null?a:Math.max(n,a);Ft(t,{...e,unclaimedVetoPoints:o})}};return document.addEventListener(`visibilitychange`,e),window.addEventListener(`beforeunload`,e),()=>{document.removeEventListener(`visibilitychange`,e),window.removeEventListener(`beforeunload`,e)}},[]);let O=e=>{t(t=>({...t,settings:{...t.settings,syncKey:e,updatedAtMs:Date.now()}}))},k=e=>{let n=h+e;t(e=>({...e,claimedVetoPoints:n})),d(0)},[A,j]=(0,_.useState)(null),ee=(e,t=`success`,n=3e3)=>{j({message:e,type:t}),setTimeout(()=>j(null),n)},M=async()=>{p(!0);try{let n=await It(b),r=e;n&&(r=x(e,n),t(r));let i=(r.sessions||[]).reduce((e,t)=>e+(t.points||0),0),a=r.claimedVetoPoints||0,o=Math.max(0,i-a),s=o;n&&n.unclaimedVetoPoints!==void 0&&(d(n.unclaimedVetoPoints),s=Math.max(o,n.unclaimedVetoPoints)),await Ft(b,{...r,unclaimedVetoPoints:s})||n?ee(`Cloud Sync successful!`,`success`):ee(`Cloud Sync failed: Server rate-limited or offline`,`error`)}catch{ee(`Cloud Sync failed`,`error`)}finally{p(!1)}},te=(0,_.useMemo)(()=>{let t=new Date().toDateString(),n=0,r=0,i=0,a=0;return(e.sessions||[]).forEach(e=>{if(e.startedAt&&new Date(e.startedAt).toDateString()===t){a+=1;let t=e.actualDurationSec===void 0?e.durationSec:e.actualDurationSec;n+=t||0,i+=e.points||0,(e.results||[]).forEach(e=>{e.status===`done`&&(r+=1)})}}),{minutesFocused:Math.round(n/60),sprintsCount:a,questionsSolved:r,pointsEarned:i}},[e.sessions]);return(0,B.jsxs)(`div`,{className:`app-container`,children:[A&&(0,B.jsxs)(`div`,{className:`global-toast-banner toast-${A.type}`,children:[A.type===`error`?(0,B.jsx)(F,{size:16}):(0,B.jsx)(I,{size:16}),(0,B.jsx)(`span`,{children:A.message})]}),(0,B.jsx)(Ke,{activeTab:n,onSelectTab:r,todayFocusMinutes:te.minutesFocused,vetoMinutes:y,vetoEnabled:!!e.settings?.vetoEnabled,onOpenVetoModal:()=>a(!0),settings:e.settings,onToggleTheme:()=>{let n=e.settings.theme===`light`?`dark-ember`:`light`;document.documentElement.setAttribute(`data-theme`,n),t(e=>({...e,settings:{...e.settings,theme:n,updatedAtMs:Date.now()}}))},isSyncing:f,onSyncCloud:M,hasActiveSprint:!!o}),(0,B.jsx)(zt,{isOpen:i,onClose:()=>a(!1),unclaimedPoints:v,syncKey:b,onUpdateSyncKey:O,onClaimPoints:k,onSyncCloud:M}),(0,B.jsxs)(`main`,{className:`app-main-content`,children:[n===`sprint`&&(o?(0,B.jsx)(bt,{activeSprintState:o,settings:e.settings,allQuestions:e.questions,questionStates:e.questionStates,onUpdateActiveSprintState:e=>{s(e)},onFinishSprint:n=>{let r=(n.results||[]).map(t=>t.status===`done`&&!t.confidence?{...t,confidence:Qe(t,e.settings)}:t),i={id:`sess_`+Date.now(),...n,results:r},a={...e.questionStates};r.forEach(e=>{a[e.questionId]={lastAttemptedAt:new Date().toISOString(),status:e.status,confidence:e.confidence||a[e.questionId]?.confidence||null}}),t(e=>({...e,questionStates:a,sessions:[...e.sessions,i]})),s(null),l(i)}}):c?(0,B.jsx)($e,{session:c,settings:e.settings,onStartNewSprint:()=>{l(null),s(null),r(`sprint`)},onGoHome:()=>l(null),onUpdateSessionConfidence:(e,n,r)=>{t(t=>{let i=t.sessions.map(i=>{if(i.id===e||!e&&i.id===t.sessions[t.sessions.length-1]?.id){let e=(i.results||[]).map(e=>e.questionId===n?{...e,confidence:r}:e);return{...i,results:e}}return i}),a={...t.questionStates,[n]:{...t.questionStates[n]||{},confidence:r}};return{...t,questionStates:a,sessions:i}}),l(e=>{if(!e)return e;let t=(e.results||[]).map(e=>e.questionId===n?{...e,confidence:r}:e);return{...e,results:t}})}}):(0,B.jsx)(pt,{questions:e.questions,settings:e.settings,onStartSprint:t=>{let n=gt(t.matchingQuestions,t.quota,e.questionStates,t.seed),r={sessionData:{...t,queue:n,startedAtMs:Date.now(),totalPausedMs:0,isPaused:!1,pauseStartedAtMs:null},currentIndex:0,attempts:0,results:[],questionStartTime:Date.now(),preCountdownDone:!1};l(null),s(r)}})),n===`bank`&&(0,B.jsx)(ut,{questions:e.questions,questionStates:e.questionStates,sessions:e.sessions,onUpdateQuestions:e=>t(t=>({...t,questions:e})),onUpdateQuestionStates:e=>t(t=>({...t,questionStates:e})),onResetToDefault:()=>t(e=>({...e,questions:DEFAULT_QUESTIONS}))}),n===`analytics`&&(0,B.jsx)(xt,{sessions:e.sessions,questionStates:e.questionStates,questions:e.questions,todayStats:te,settings:e.settings}),n===`settings`&&(0,B.jsx)(Rt,{settings:e.settings,questions:e.questions,sessions:e.sessions,onSaveSettings:e=>{t(t=>({...t,settings:{...e,updatedAtMs:Date.now()}}))},onImportJSON:e=>{Array.isArray(e)?t(t=>({...t,questions:e})):e&&e.questions&&t(t=>({...t,questions:e.questions,settings:e.settings||t.settings}))},onImportCSV:e=>{t(t=>({...t,questions:e}))},onResetData:()=>{window.confirm(`Are you sure you want to reset all data to defaults? This action cannot be undone.`)&&(localStorage.clear(),t(Dt()),s(null),l(null))},onForceUpload:async()=>{p(!0);let t=(e.sessions||[]).reduce((e,t)=>e+(t.points||0),0),n=e.claimedVetoPoints||0,r=Math.max(0,t-n),i=u===null?r:Math.max(u,r);await Ft(b,{...e,unclaimedVetoPoints:i}),p(!1),alert(`State successfully forced to cloud!`)}})]})]})}(0,v.createRoot)(document.getElementById(`root`)).render((0,B.jsx)(_.StrictMode,{children:(0,B.jsx)(Bt,{})}));